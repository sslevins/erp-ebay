...
<html>
 <body>
 <div style="width:81mm;height:58mm;background-corlor:White;font-size:12px;"> 
<?php
...
//idPrint3.disabled = false; 
   ...
   <?php
 	for($i=0;$i<count($sql);$i++){
				...
				$ebay_noteb		= $sql[$i]['ebay_note']?$sql[$i]['ebay_note']:"&nbsp;&nbsp;";	
...
<div style="width:80mm;height:29mm;background-corlor:White;margin-top:10px;line-height:5mm">     
...
<div style="width:80mm;margin-bottom:10px;">   
<?php echo "...................................";?>  
<?php echo "<br>";?>  
 <?php
...
<?php if($g==(count($ss)-1))echo "(挂号)";?>   
<?php if($g==(count($ss)-1))echo "<br>";?>
<?php if($g==(count($ss)-1)) echo $ebay_note;?>          
<?php }
