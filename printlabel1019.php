...
$Shipping		= $_REQUEST['Shipping'];
 ...
 ?>
	<div style="width:96mm;height:96mm;float:left;border:2px solid #000000;padding:2mm;font-size:12px; margin:2px 1px">
		<div style="width:100%;height:15mm;border-left:1px dashed #000000;border-right:1px dashed #000000;border-bottom:1px solid #000000">
			<?php
		...
		<div style="width:100%;height:5mm;border-bottom:1px solid #000000; line-height:5mm">
		...
		<div style="width:100%;height:30mm;padding-top:6mm;">
			<div style="width:50%;height:24mm;float:left;">
				<ul style="width:100%;">
					<li style="width:100%; height:5mm; line-height:5mm">From:<?php echo $fromuser;?></li>
		...
		<div style='width:100%; position:relative'>
			<div style='width:95%;float:left; font-size:16px; overflow:hidden;'>
				<ul style="margin-left:5px;">
					...
					<li style="width:100%; height:6mm; line-height:6mm"><span style='margin-left:40px;'><strong><?php echo $countryname?></strong></span></li>
				</ul>
			</div>
	...
	<?php 
	if(($i+1)%2==0){
		echo "<div style='clear:both;'>wwww</div>";
	}
}
?>
</div>
