<?php
	...
	$country['Zimbabwe']				=	'津巴布韦';
		...
		$ertj		= "";
			...
			$sql			= "select a.*,b.sku from ebay_order as a join ebay_orderdetail as b on a.ebay_ordersn=b.ebay_ordersn where a.ebay_userid !='' and ($ertj) group by a.ebay_id order by b.sku asc ";
...
<?php
 	...
 	for($i=0;$i<count($sql);$i++){
				...
				$ebay_noteb		.= $sql[$i]['ebay_note'];
				if($street2 == ''){
					
					$addressline	= "Send To:".$cname."<br>".$street1."<br>".$city.", ".$state."<br>".$zip."<br>".$countryname.'('.$country[$countryname].')';
				
				}else{
				
					$addressline	= "Send To:".$cname."<br>".$street1."<br>".$street2."<br>".$city.", ".$state."<br>".$zip."<br>".$countryname.'('.$country[$countryname].')';
    ...
    <table width="100%" height="100" border="0" cellpadding="0" cellspacing="0" style="border:1px dashed #999999">
      ...
      <tr>
        ...
        <td><div align="right">
          <table width="100%" border="0" cellspacing="0" cellpadding="1" style="border-bottom:5px #000000 solid">
            <tr>
              <td width="50%"><img src="barcode128.class.php?data=<?php echo $ebay_id;?>" alt="" width="143" height="38" />    <?php echo $ebay_id;?> Buyer ID : <?php echo $userid;?></td>
              <td rowspan="2" valign="top"><div align="right">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  
                  <tr>
                    <td width="47%"><?php echo ($i+1).' / '.$totalpages;?>&nbsp;</td>
                    <td width="53%"><?php echo date('Y-m-d');?></td>
                  </tr>
                  <tr>
                    <td colspan="2">
                      <div align="left">邮寄方式</div></td>
                  </tr>
                  <tr>
                    <td colspan="2"><div align="left"><?php echo $ebay_carrier;?></div></td>
                  </tr>
                </table>
                </div></td>
            </tr>
      ...
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-bottom:5px #000000 solid">
          <tr>
            <td width="41%" valign="top"><span class="STYLE4"><?php echo $addressline; ?><br />
            Phone:<?php echo $tel;?></span></td>
            <td width="59%" valign="top"><span class="STYLE4"><span class="STYLE6">&nbsp;<span class="STYLE7">拣货人:_________ 二次拣货人___________ <br />
                  <br />
              扫描人: __________ 
              包货人:__________</span></span><strong><br />
              <br />
              操作员: <?php echo $_SESSION['truename'];?><br />
            </strong></span></td>
          </tr>
      ...
      <tr>
		...
		?>
          ...
          <tr>
            ...
            <?php if($ebay_id > 0 ){ ?>            <?php } ?>            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="13%" rowspan="4"><span class="STYLE8"><img src="<?php echo $ebay_itemurl; ?>" width="76" height="70" />&nbsp;</span></td>
                <td width="60%"><span class="STYLE8">SKU :<?php echo $sku;?>货位号:<?php echo $goods_location;?></span></td>
                <td width="27%"><span class="STYLE8">数量：<?php echo $amount;?></span></td>
              </tr>
              <tr>
                <td><span class="STYLE8">名称:<?php echo $goods_name; ?></span></td>
                <td><span class="STYLE8">重量:<?php echo $goods_weight; ?></span></td>
              </tr>
			  <tr>
                <td colspan="2"><span class="STYLE8">颜色/尺寸<?php echo $attribute; ?></span></td>
              </tr>
              <tr>
                <td colspan="2"><span class="STYLE8">备注:<?php echo $ebay_noteb;?></span></td>
              </tr>
            </table></td>
            <td width="54%" colspan="3" align="center" bgcolor="#FFFFFF">
            <?php
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="12%" rowspan="4"><span class="STYLE8"><img src="<?php echo $ebay_itemurl; ?>" alt="" width="76" height="70" />&nbsp;</span></td>
                <td width="61%"><span class="STYLE8">SKU :<?php echo $sku;?> 货位号:<?php echo $goods_location;?></span></td>
                <td width="27%"><span class="STYLE8">数量：<?php echo $amount;?></span></td>
              </tr>
             <tr>
                <td><span class="STYLE8">名称:<?php echo $goods_name; ?></span></td>
              ...
              <tr>
                <td colspan="2"><span class="STYLE8">备注:<?php echo $notes;?></span></td>
              </tr>
            </table>
            <?php } ?></td>
            </tr>
