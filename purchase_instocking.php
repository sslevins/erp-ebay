...
include "top.php";
	...
	$type	= $_REQUEST['type'];
		...
		$ids = explode(',',$id);
		foreach($ids as $k=>$v){
			$vvsql		= "update ebay_iostore set type ='98' where id='$v'";
			if($dbcon->execute($vvsql)){
...
<table cellpadding='0' cellspacing='0' width='100%' border='0' class='list view'>
	<tr class='pagination'>
		<td colspan='6'>&nbsp;			</td>
				...
				<div style='white-space: nowrap;'width='100%' align='left'>单号</div>			</th>
		            ...
		            <th scope='col' nowrap="nowrap">添加用户/采购人员</th>
   ...
   <?php 
				  	...
				  	$sql = "select * from  ebay_iostore as a  where a.ebay_user='$user' and a.type='93' and a.io_status='0'";	
					  
					if($keys != '') $sql = "select a.*,b.goods_sn from  ebay_iostore as a join ebay_iostoredetail as b on a.io_ordersn = b.io_ordersn where a.ebay_user='$user' and a.type='93' and a.io_status='0' and b.goods_sn='$keys' ";	
				  ...
				  ?>
					<tr height='20' class='oddListRowS1'>
                            ...
                            <?php if($user == 'vipallen'){?>
                             ...
                             <a href="toxls/pruchase_print02.php?id=<?php echo $id;?>"   target="_blank">打印2</a>
			...
			<table border='0' cellpadding='0' cellspacing='0' width='100%' class='paginationTable'>
				<tr>
					<td nowrap="nowrap" class='paginationActionButtons' align="center">
					 <input name="submit1" type="button" onclick="saveorders()" value="批量转为入库单" />
...
function printorders(){
	...
	function del(id){
		if(confirm('您确认删除此条记录吗')){
			location.href = 'purchase_instocking.php?module=purchase&action=&stype=<?php echo $stype; ?>&id='+id+'&type=del&dstatus=<?php echo $dstatus; ?>';
		}
	}
	...
	function searchorder(){
		...
		location.href	= 'purchase_instocking.php?keys='+keys+"&module=purchase&action=&stype=<?php echo $stype; ?>&dstatus=<?php echo $dstatus; ?>&warehouse="+warehouse+"&startdate="+startdate+"&enddate="+enddate;
	...
	function saveorders(){
		...
		var url = 'purchase_instocking.php?module=purchase&bill='+bill+"&type=plinstock";
		location.href	= url;
	}
	function instock(id){
		var url = 'purchase_instocking.php?module=purchase&id='+id+"&type=instock";
		location.href	= url;
	}
