...
<h2><?php echo $_REQUEST['action'].$status;?> </h2><br />
备注：主要显示，从ebay同步进来的时的订单，自动记录出库操作。
...
<tr>
	...
	<td nowrap="nowrap" scope="row" >&nbsp;&nbsp;&nbsp;
	 开始时间：
      ...
      SKU:<input name="sku" type="text" id="sku" />
...
<option value="-1">Please Select</option>
					...
					$sql	 = "select * from ebay_account as a  where ebay_user='$user' ";
	  ...
	  <input type="button" value="导出" onclick="exportorder()" /></td>
</tr>
</table>
</div>
			  ...
			  ?>
         		...
         		<tr height='20' class='oddListRowS1'>
						<td scope='row' align='left' valign="top" ><input name="ordersn" type="checkbox" id="ordersn" value="<?php echo $goods_id;?>" ><?php echo $goodsid;?></td>
						    ...
						    <td scope='row' align='left' valign="top" ><?php echo $ebay_currency; ?></td>
						    <td scope='row' align='left' valign="top" ><?php echo $goodsprice; ?></td>
...
function searchorder(){
		...
		var url = 'productinstockindex.php?startdate='+startdate+"&enddate="+enddate+"&account="+account+"&goodscategory="+goodscategory+"&module=warehouse&action=<?php echo $_REQUEST['action'];?>&type=<?php echo $_REQUEST['type'];?>&sku="+sku;
	...
	function exportorder(){
		...
		var url = 'productinstockindexxls.php?startdate='+startdate+"&enddate="+enddate+"&account="+account+"&goodscategory="+goodscategory+"&module=warehouse&action=<?php echo $_REQUEST['action'];?>&type=<?php echo $_REQUEST['type'];?>&sku="+sku;
