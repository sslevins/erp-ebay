...
.textc{text-align:center;}
 ...
 <body>
 <div style="width:102mm;font-size:16px; margin:0 auto; font-family: arial;"> 
<?php
	@session_start();
	...
	$ie=1;
	$ertj		= "";
	$orders		= explode(",",$_REQUEST['ebay_id']);
	...
	$sql	= "select a.*,b.ebay_itemtitle,b.ebay_itemid,b.sku,b.ebay_amount from ebay_order as a join ebay_orderdetail as b on a.ebay_ordersn = b.ebay_ordersn  where ($ertj) and a.ebay_user='$user'  order by  a.ebay_username asc ";
	...
	$sql	= $dbcon->getResultArray($sql);	
 	for($i=0;$i<count($sql);$i++){
				...
				$ss		= "update ebay_order set isprint ='1' where ebay_id ='$ebay_id'";
				$ss		= $dbcon->execute($ss);
				...
				$paidtime		= $sql[$i]['ebay_paidtime']?date('Y-m-d',$sql[$i]['ebay_paidtime']):"&nbsp;";
...
<div style="width:101mm;border:1px solid black;font-size:12px;">

<div style="width:101mm;height:8mm;margin-top:5px;line-height:6mm;font-size:26px;border-bottom:1px solid black; font-weight:bold;">     
...
<div style="width:101mm;text-align:left; border-bottom:1px solid black;">
<div style="width:98%; height:96%; border:1px solid #000000; margin:3px 0 3px 3px; font-size:26px;">
Phone:<?php
		echo $tel.'<br>';
		echo $street1.'<br>';
...
<div style="width:101mm;text-align:left;">
<table width='100%' cellpadding='0' cellspacing='0'>
	<tr height='30'>
		<td colspan='5' class='b'>&nbsp;</td>
	</tr>
	<tr height='30'>
		<td colspan='3' class='b r' style='font-size:20px;font-weight:bold;line-height:30px'><?php echo $ebayaccount;?>&nbsp;&nbsp;<?php echo $sku;?></td>
		<td colspan='2' class='b'><span style='font-size:20px;font-weight:bold;margin-left:20px; line-height:30px'>·&nbsp;<?php echo $i+1;?>&nbsp;·</span></td>
	</tr>
	<tr><td colspan='5'>
		<table width='100%' cellpadding='0' cellspacing='0'>
			<tr height='30'><td class='b r' width='60%'>&nbsp;</td>
				<td class='b r' width='30%' style="line-height:30px" ><font color="#7a7a7a" style='font-weight:bold;'>&nbsp; Date</font></td>
				<td class='b' width='10%'>&nbsp;</td>
			</tr>
			<tr height='30'><td class='b r'>&nbsp;</td>
				<td class='b r textc'  style="line-height:30px"><?php echo $paidtime;?></td>
				<td class='b'>&nbsp;</td>
			</tr>			
		</table>
	</td></tr>
	<tr height='30'>
		<td width='10%' class='b r'  style="line-height:30px"><font color="#7a7a7a" style='font-weight:bold; font-size:20px;'> &nbsp;QTY</font></td>
		<td width='30%' class='b r'  style="line-height:30px"><font color="#7a7a7a" style='font-weight:bold; font-size:20px;'> &nbsp;Item #</font></td>
		<td width='30%' class='b r'  style="line-height:30px"><font color="#7a7a7a" style='font-weight:bold; font-size:20px;'> &nbsp;Item Name</font></td>
		<td width='10%' class='b r'>&nbsp;</td>
		<td width='10%' class='b'>&nbsp;</td>
	</tr>
	<tr>		
		<td class='b r textc'  style="line-height:30px"><?php echo $amount;?></td>
		<td class='b r textc'  style="line-height:30px"><?php echo $itemid;?></td>
		<td class='b r'  style="line-height:20px"><?php echo $itemtitle;?></td>
		<td class='b r textc'  style="line-height:30px"><?php echo 'Total:';?></td>
		<td class='b textc'  style="line-height:30px"><?php echo $ebay_currency.'<br>'.$ebay_total?></td></tr>
	<tr height='30'>		
