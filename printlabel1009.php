...
include "include/config.php";
	...
	$country['Zimbabwe']				=	'津巴布韦';
		...
		$ertj		= "";
			...
			$sql			= "select a.*,b.sku from ebay_order as a join ebay_orderdetail as b on a.ebay_ordersn=b.ebay_ordersn where  ($ertj)  group by a.ebay_id   order by  a.ebay_id ";
...
//idPrint3.disabled = false; 
   ...
   $ipage						= 8;
 	...
 	for($i=0;$i<count($sql);$i++){
		...
		$ebay_account0		= $sql[$i]['ebay_account'];
		...
		$sl					= "select * from ebay_orderdetail where ebay_ordersn ='$ebay_ordersn' and ebay_user	='$user'";
		$sl					= $dbcon->execute($sl);
		...
		$fstr				= $appname.$title1.$title;
		$addressline	='';
		$title			= '<b>'.$title."</b>";
		if($street2 == ''){
			$addressline		= "<span style=\"font-family:\'Times New Roman\'\"><b>To:".$name."</b></span>".'<span style="font-size:17px;font-family:\'Times New Roman\'">'."<br>".$street1."<br>".$city.", ".$state." ".$zip."<br>".$countryname."(".$country[$countryname].")";
			
		}else{
			$addressline		= "<span style=\"font-family:\'Times New Roman\'\"><b>To:".$name."</b></span>".'<span style="font-size:17px; font-family:\'Times New Roman\'">'."<br>".$street1."<br>".$street2."<br>".$city.", ".$state." ".$zip."<br>".$countryname."(".$country[$countryname].")";
		}
		...
		if($ebay_account != ''){
		$ebay_id2			= $sql[$i]['ebay_id'];
		$ebay_ordersn2				= $sql[$i]['ebay_ordersn'];
		
		$ebay_account2		= $sql[$i]['ebay_account'];
		$ebay_account		= $sql[$i]['ebay_account'];
		$ebay_carrier2		= $sql[$i]['ebay_carrier'];
		...
		$vv					= $dbcon->getResultArray($vv);
		$appname			= $vv[0]['appname'];
		$sl					= "select * from ebay_orderdetail where ebay_ordersn ='$ebay_ordersn2' and ebay_user	='$user'";
		$sl					= $dbcon->execute($sl);
		$sl					= $dbcon->getResultArray($sl);
		...
		$fstr2				= $appname.$recordnumber1.'-'.$title;
		...
		$ebay_createdtime1				= date('Y-m-d',$sql[$i]['ebay_paidtime']);
		$ebay_createdtime1				= date('y.m.d',strtotime("$ebay_createdtime1 +1 days"));

		$addressline1	='';
		
		if($street2 == ''){
			$addressline1		= "<span style=\"font-family:\'Times New Roman\'\"><b>To:".$name."</b></span>".'<span style="font-size:17px;font-family:\'Times New Roman\'">'."<br>".$street1."<br>".$city.", ".$state." ".$zip."<br>".$countryname."(".$country[$countryname].")";
			
			
		}else{
			$addressline1		= "<span style=\"font-family:\'Times New Roman\'\"><b>To:".$name."</b></span>".'<span style="font-size:17px; font-family:\'Times New Roman\'">'."<br>".$street1."<br>".$street2."<br>".$city.", ".$state." ".$zip."<br>".$countryname."(".$country[$countryname].")";
			
		}
		$addressline1	  	= str_replace("&acute;","'",$addressline1);
		$addressline1  		= str_replace("&quot;","\"",$addressline1);
		if($tel != '') $addressline1 .= "<br>Tel:".$tel;
...
<table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" >
  ...
  <tr>   
    ...
    <td width="110" align="center" valign="middle">Record No.</td>
    <td width="210" align="left" valign="middle"><?php echo $fstr;?>&nbsp;</td>
    <td width="146" align="left" valign="middle"><?php echo $ebay_carrier;?></td>
    <td width="147" align="left" valign="middle"><?php echo $i-1;?>&nbsp;</td>
    <td width="19" align="left" valign="middle">&nbsp;</td>
    <td width="211" align="center" valign="top">Record No.</td>
    <td width="219" align="left" valign="top"><?php echo $fstr2;?>&nbsp;</td>

    <td width="111" align="left" valign="top"><?php echo $ebay_carrier2;?></td>
    <td width="111" align="left" valign="top"><?php echo $i;?>&nbsp;</td>
  </tr>
  <tr>
    <td colspan="4" align="left" valign="middle">&nbsp;
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td><div align="center"><img src="barcode128.class.php?data=<?php echo $ebay_id ?>" alt=""/><br />
              <?php 
		if($ebay_account0 == 'ultraok') echo 'z';
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><?php echo $addressline1;
		  			$addressline1	='';
		   ?></td>
          <td><div align="center"><img src="barcode128.class.php?data=<?php echo $ebay_id2 ?>" alt=""/><br />
              <?php 
		if($ebay_account2 == 'ultraok') echo 'z';
  ...
  <tr>
    <td colspan="4" align="center" valign="middle"><table width="100%" border="0">
      
      <?php
	  
	  $ss		= "select * from ebay_orderdetail where ebay_ordersn='$ebay_ordersn' and ebay_ordersn!=''";
	
	  $ss		= $dbcon->execute($ss);
	  $ss		= $dbcon->getResultArray($ss);
	  if(count($ss)>=2) $ipage = 6;
	  
	  for($r=0;$r<count($ss);$r++){
		  	
			$sku				= $ss[$r]['sku'];
			$ebay_amount		= $ss[$r]['ebay_amount'];
			$ebay_itemtitle		= $ss[$r]['ebay_itemtitle'];
			$sss = "select notes from ebay_productscombine where goods_sn='$sku'";
			$sss = $dbcon->execute($sss);
		    $sss = $dbcon->getResultArray($sss);
			if($sss){
				$goods_name = $sss[0]['notes'];
			}else{
			$sg	= "select * from ebay_goods where goods_sn = '$sku' and ebay_user ='$user'";
			$sg = $dbcon->execute($sg);
      ...
      <tr>
        ...
        <td style="border-right: #000 solid 1px"><?php echo $sku;?>&nbsp;</td>
        <td style="border-right: #000 solid 1px"><font style='font-size:12px'><?php   echo $goods_name;?></font>&nbsp;</td>
        <td style="border-right: #000 solid 1px">*<?php echo $ebay_amount;?>&nbsp;</td>
      </tr>
    ...
    <table width="100%" border="0">
	  ...
	  $ss		= "select * from ebay_orderdetail where ebay_ordersn='$ebay_ordersn2' and ebay_ordersn != ''";
      ...
      <tr>
        ...
        <td style="border-right: #000 solid 1px"><?php echo $sku;?>&nbsp;</td>
        <td style="border-right: #000 solid 1px"><?php echo $sg[0]['goods_name'];?>&nbsp;</td>
        <td style="border-right: #000 solid 1px">*<?php echo $ebay_amount;?>&nbsp;</td>
      </tr>
...
<?php  if(($i+1)%8 == 0) {
	...
	echo '<div style="text-align:right">Current Pages:'.$pages.'</div>';
	$pages	++;
	$ipage					= 8;
