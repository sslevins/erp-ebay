	...
	<tr class='pagination'>
		<td width="65%">
			<table border='0' cellpadding='0' cellspacing='0' width='100%' class='paginationTable'>
				<tr>
					<td nowrap="nowrap" class='paginationActionButtons'><form action="salehistoryuploadsave.php" enctype="multipart/form-data" method="post" target="_blank">
<table border="0"  cellpadding="10" cellspacing="1" bgcolor="#c0ccdd" id="content">
  <tr>
    <td>选择帐号</td>
    <td><select name="account" id="account">
    
     <option value="">请选择SalesHistory导入帐号</option>
      <?php 
  ...
  <tr>
    ...
    <td><input name="提交" type="submit" class="button" value="更新" onclick="return checkupdate()" /></td>
					  ...
					  <p><br />
				    订单导入模板下载:<a href="SalesHistorytemp.xls" target="_blank">下载</a><br />
					  </p>
					  <p>&nbsp;</p>
					  <p><br />
			            </p></td>
