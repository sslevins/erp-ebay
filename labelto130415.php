...
$objPHPExcel->getProperties()->setCreator("Maarten Balliauw")
	...
	$sql	= "select a.*,b.sku,b.ebay_amount,b.recordnumber as bre,b.ebay_id as cc, b.* from ebay_order as a join ebay_orderdetail as b on a.ebay_ordersn = b.ebay_ordersn where ($ertj) and a.ebay_user='$user' and a.ebay_combine!='1' order by a.ebay_username";	
	}
