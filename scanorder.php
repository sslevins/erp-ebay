				    ...
				    <table width="100%" border="0" align="center">
				      ...
				      <tr>
				        ...
				        <td width="53%"><DIV style="font-size:36px">1.订单号/跟踪号:
				          ...
				          <input name="order" type="text" id="order" onkeydown="check01()" style="width:280px; height:50px; font-size:24px" />
				        ...
				        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            ...
                            <td><div style="font-size:36px">3.录入挂号，完成！</div></td>
				        ...
				        <input name="tracknumber" type="text" id="tracknumber" onkeydown="check02()" style="width:270px; height:50px; font-size:24px"  />
...
<script language="javascript">
	...
	function xlsbaobiao(){
		...
		var url			= 'xlsbaobiao.php?start='+start+"&end="+end;
	...
	if(currentweight >= 0) document.getElementById('currentweight').value = currentweight;
...
function updateweight2(){
			...
			var param	= "type=updateweight&ebayid="+ebayid+"&currentweight="+currentweight;
        ...
        if(xmlHttpRequest.readyState == 4){  
            ...
            if(xmlHttpRequest.status == 200){  
				...
				if(res == '1'){
					...
					document.getElementById('mstatus').innerHTML="<font color='#33CC33'>重量同步成功,请输入跟踪号</font>";
