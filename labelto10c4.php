...
$objPHPExcel->getProperties()->setCreator("Maarten Balliauw")
	...
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('C1', '交易单号');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('D1', '客户帐号');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('E1', '客户姓名');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('F1', '客户邮箱');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('G1', '电话');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('H1', '国家');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('I1', '所属地区');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('J1', '所属城市');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('K1', '邮政编码');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('L1', '联系传真');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('M1', '邮寄地址');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('N1', '邮寄备用地址');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('O1', 'Paypal');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('P1', '货运方式');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('Q1', '货运单号');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('R1', '订单金额');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('S1', '运费金额');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('T1', '订购商品清单');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('U1', '供应商');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('V1', '重量');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('W1', '备注信息');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('X1', '多物品选择');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('Y1', 'Shipping Service');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('Z1', '店铺');
	...
	for($i=0;$i<count($sql);$i++){
		...
		$strlinestr			= substr($strlinestr,0,strlen($strlinestr)-1);
		$tt0		= $totalsbjz / $qty ;
		...
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('G'.$a, $tel, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('H'.$a, $countryname, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('I'.$a, $state, PHPExcel_Cell_DataType::TYPE_STRING);
		...
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('M'.$a, $street1.' '.$street2, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('T'.$a, $strlinestr, PHPExcel_Cell_DataType::TYPE_STRING);
