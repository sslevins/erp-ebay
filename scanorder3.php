...
function updateweight2(){
		...
		alert('请先扫描订单号');
			...
			var param	= "type=tracknumber3&ebayid="+ebayid+"&packagingstaff="+packagingstaff+"&currentweight="+currentweight;			sendRequestPost2(url,param);
	...
	function check01(){
		...
		if (keyCode == 13) {
			...
			var url		= "getajax2.php";
			var param	= "type=checkorder02&ebayid="+ebayid;
