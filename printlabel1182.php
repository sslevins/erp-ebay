...
//idPrint3.disabled = false; 
   ...
   $pages	= 1;
 	...
 	for($i=0;$i<count($sql);$i++){
				...
				if($cncountryname == ''){
					...
					$cncountrysql	 = "select countrycn from ebay_countrys where countryen='$countryname' and ebay_user ='$user' ";					
					$cncountrysql	 = $dbcon->execute($cncountrysql);
					$cncountrysql	 = $dbcon->getResultArray($cncountrysql);
					$cncountryname	 = $cncountrysql[0]['countrycn'];
				}
				...
				if($street2 != ''){
					...
					$addressline	= $cname."<br>".$street1.",".$street2."<br>".$city.",".$state.",".$zip."<br>".$countryname."(".$cncountryname.")";
					
				
				}else{
					
					$addressline	= $cname."<br>".$street1."<br>".$city.", ".$state.",".$zip."<br>".$countryname."(".$cncountryname.")";
  ...
  ?>
<table  border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" style="width:250mm; text-align: right; padding:2px">
  ...
  <tr>   
    ...
    <td width="" align="center" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding:0px">
      
      
      
      <tr>
        <td><span class="STYLE16"></span></td>
        <td width="96%" colspan="3"><div align="left" style="margin:0px 0px 1px 1px; font-size:16px; font-family:Arial, Helvetica, sans-serif; width:200px"><?php echo strtoupper($addressline);?></div></td>
        <td width="6%" height="100" valign="top"><span class="STYLE16"></span>
          <table width="80%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td align="right"><?php echo $recordnumber;  ?>
                <div align="right"></div></td>
            </tr>
            <tr>
              <td><br />
                <img src="barcode128.class.php?data=<?php echo $ebayid; ?>" alt="" width="167" height="66"/></td>
            </tr>
            <tr>
              <td><div align="center"><?php echo $ebayid;?>&nbsp;
              </div>
    ...
    <td width="403" align="center" valign="top"><table width="100%" border="0" cellspacing="1" cellpadding="3">
        
        <tr>
          <td><div align="left" style="margin:10px; font-size:12px; font-family:Arial, Helvetica, sans-serif;width:250px;float:left">
            <?php
		...
		for($o=0;$o<count($sl);$o++){			
			...
			if(count($rr) > 0){
									...
									for($e=0;$e<count($goods_sncombine);$e++){
											...
											$lstr = $goods_ywsbmc.' '.$goods_sbjz;
											
											
											
										$yy			= "select * from ebay_goods where goods_sn='$goods_sn' and ebay_user = '$user'";
			...
			$goods_zysbmc	= $yy[0]['goods_zysbmc'];
			$goods_sbjz	= $yy[0]['goods_sbjz'];
			
			
			$imurl		= "<img src='images/".$yy[0]['goods_pic']."' width='50' height='50' style='float:right; margin:5px' />";
			
			echo "<font style='font-weight: bold;'>".$goods_sn.' '.$attribute."  {$goods_location}&nbsp;&nbsp;&nbsp; ".$goods_name.' '." X ".$goddscount."/</font>  ".$imurl."<br>";	
			...
			echo "<font style='font-weight: bold;'>".$sku.' &nbsp;&nbsp;&nbsp;'.$attribute."  {$goods_location} ".$goods_name." X ".$amount."/</font> ".$imurl."<br>";			
        ...
        <tr>
          <td colspan="2">
            <span class="STYLE17"><?php  
			
			echo $ebay_id.'<br>';
			
			echo '客户ID &nbsp: '.$userid.' 运输: '.$ebay_carrier.'<br>';
		  if($ebay_note != '' ) echo 'eBay Note: '.$ebay_note;
