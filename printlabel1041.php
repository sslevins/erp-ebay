...
<?php
	...
	$country['Zimbabwe']				=	'津巴布韦';
		...
		$ertj		= "";
			...
			$sql			= "select a.*,b.sku from ebay_order as a join ebay_orderdetail as b on a.ebay_ordersn=b.ebay_ordersn where ($ertj) group by a.ebay_id order by  b.ebay_itemid,b.sku ";
   ...
   $pages	= 1;
 	...
 	for($i=0;$i<count($sql);$i++){
				...
				if($street2 != ''){
					...
					$addressline	= $cname."</strong><br>".$street1.",".$street2."<br>".$city.",".$state.",".$zip."<br>".$countryname."(".$country[$countryname].")";
					
				
				}else{
					
					$addressline	= $cname."</strong><br>".$street1."<br>".$city.", ".$state.",".$zip."<br>".$countryname."(".$country[$countryname].")";
  ...
  <tr>   
    ...
    <td width="480" align="center" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding:5px">
      ...
      <tr>
        ...
        <td width="96%" colspan="3" valign="top"><div align="left" style="margin:0px 0px 0px 0px; font-size:12px; font-family:Arial, Helvetica, sans-serif; border-bottom:#000000 dashed 2px">
        <?PHP
		...
		echo '<strong>From</strong>:JZP<br />

P.O.BOX,NO.87341,TO KWA<br />
WAN POST OFFICE,HONGKONG'	;
        ...
        <div align="left" style="margin:0px 0px 5px 10px; font-size:18px; font-family:Arial, Helvetica, sans-serif"><?php 
		

		
		
		echo "TO:<strong>".strtoupper($addressline);?></div></td>
        <td width="6%" height="100" valign="top"><span class="STYLE16"></span>
          <table width="80%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td><table width="100%" border="1" cellspacing="0" cellpadding="0" style="font-size:10px">
                <tr>
                  <td align="center" valign="middle">E</td>
                  <td align="center" valign="middle">POSTAGE PAID HONG KONG PORT PAYE</td>
                  <td align="center" valign="middle">PERMIT NO.<br />
                    5458</td>
                </tr>
              </table></td>
            </tr>
            ...
            <tr>
              <td><img src="barcode128.class.php?data=<?php echo $ebayid; ?>" alt="" width="119" height="46"/></td>
            </tr>
            <tr>
    ...
    <td width="308" align="center" valign="top"><table width="100%" border="0" cellspacing="1" cellpadding="3">
		...
		for($o=0;$o<count($sl);$o++){			
			...
			echo "<font style='font-weight: bold;'>".$sku.$attribute.$ebay_itemtitle."  {$goods_location} ".$goods_name."] X ".$goddscount."/</font><br>";	
			...
			echo "<font style='font-weight: bold;'>".$sku.$attribute.$ebay_itemtitle."  {$goods_location} ".$goods_name."] X ".$amount."/</font>";			
