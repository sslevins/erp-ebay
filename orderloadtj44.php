				  ...
				  ?>
						...
						for($i=0;$i<count($ss);$i++){					
                          ...
                          <tr>
                            ...
                            <span style="white-space:nowrap;"><a href="orderindex.php?module=orders&ostatus=100&action=所有订单&account=<?php echo $acc;?>"><span><font color="#FF0000">
                            <font color="#FF0000">
                              <?php
$sql	= "select count(ebay_id) as cc from ebay_order where ebay_user='$user' and ebay_combine!='1'  and ebay_account='$acc'";
...
<?php } ?> 
                            ...
                            <td>
                              <span style="white-space:nowrap;"><a href="orderindex.php?module=orders&ostatus=2&action=已经发货&account=<?php echo $acc;?>"><span><font color="#FF0000">
                          
                            <font color="#FF0000">
                            
                            
                              <?php
$sql	= "select count(ebay_id) as cc from ebay_order where ebay_user='$user' and ebay_status ='2' and ebay_combine!='1'  and ebay_account='$acc'";
$sql	= $dbcon->execute($sql);
$sql	= $dbcon->getResultArray($sql);
echo $sql[0]['cc'];
?>
