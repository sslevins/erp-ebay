...
include "top.php";
	...
	if($_POST['submit']){
			...
			$sql	= "insert into ebay_hkpostghcalcfee(firstweight,nextweight,discount,countrys,name,ebay_user,handlefee,xx0,xx1) values('$firstweight','$nextweight','$discount','$countrys','$name','$user','$handlefee','$xx0','$xx1')";
			
			
			
			}else{
			
			$sql	= "update ebay_hkpostghcalcfee set firstweight='$firstweight',handlefee='$handlefee',nextweight='$nextweight',xx0='$xx0',xx1='$xx1',discount='$discount',countrys='$countrys',name='$name' where id=$id";
			}
		...
		$sql = "select * from ebay_hkpostghcalcfee where id=$id";
			...
			<table border='0' cellpadding='0' cellspacing='0' width='100%' class='paginationTable'>
				<tr>
					<td nowrap="nowrap" class='paginationActionButtons'>			
                      <form id="form" name="form" method="post" action="hkpostghshipfeelistadd.php?module=system&action=运费管理&id=<?php echo $id;?>">
