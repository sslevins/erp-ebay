...
$objPHPExcel->getProperties()->setCreator("Maarten Balliauw")
	...
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('A1', '日期客户ID');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('B1', '记录编号');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('C1', '地址');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('D1', '产品编号');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('E1', '货位号');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('F1', '数量');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('G1', '型号');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('H1', '总价');
	...
	for($i=0;$i<count($sql);$i++){
		...
		$addressline		.= ",".chr(13).$countryname.' '.$zip;
		
		if($tel != '') $addressline .= chr(13).$tel;
		...
		for($o=0;$o<count($sl);$o++){
			...
			if(count($rr) > 0){
				...
				for($e=0;$e<count($goods_sncombine);$e++){
						...
						$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('B'.$a, $ebay_account.$recordnumber, PHPExcel_Cell_DataType::TYPE_STRING);
						...
						$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('E'.$a, $goods_location, PHPExcel_Cell_DataType::TYPE_STRING);
						$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('F'.$a, $goddscount, PHPExcel_Cell_DataType::TYPE_STRING);
						$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('G'.$a, $goods_name, PHPExcel_Cell_DataType::TYPE_STRING);
						$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('H'.$a, $ebay_total, PHPExcel_Cell_DataType::TYPE_STRING);
						$a++;
