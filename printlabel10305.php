   ...
   $pages	= 1;
 	...
 	for($i=0;$i<count($sql);$i++){
				...
				if($street2 != ''){
					...
					$addressline	= $cname."<br>".$street1.",".$street2."<br>".$city.",".$state.",".$zip."<br>".$countryname."(".$country[$countryname].")";
  ...
  <tr>   
    ...
    <td width="480" align="center" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding:5px">
      ...
      <tr>
        ...
        <td width="96%" colspan="3"><div align="left" style="margin:0px 0px 5px 10px; font-size:35px; font-family:Arial, Helvetica, sans-serif"><?php echo "TO:<br>".$addressline;?></div></td>
        <td width="13%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><div align="center"></div></td>
          </tr>
          <tr>
            <td><div align="center" style="font-family:Arial, Helvetica, sans-serif"></div></td>
          </tr>
        </table></td>
    ...
    <td width="308" align="center" valign="top"><table width="100%" border="0" cellspacing="1" cellpadding="3">
        ...
        <tr>
          <td><div align="left" style="margin:10px; font-size:12px; font-family:Arial, Helvetica, sans-serif">
            物品:
			<?php
		...
		for($o=0;$o<count($sl);$o++){			
			...
			//echo $goods_sn."  {$goods_location} ".$goods_name." X ".$goddscount."/<br>";	
		...
		//	echo $sku."  {$goods_location} ".$goods_name." X ".$amount."/<br>";			
        ...
        <tr>
          <td>
            <span class="STYLE17"><?php echo '客户ID:'.$userid.' '.$ebay_carrier;
		  
		  
		  if($ebay_note != '') echo $ebay_note;
		  if($ebay_noteb != '') echo $ebay_noteb;
		  
		  
		  echo '<br>总价:'.$ebay_currency.': '.$ebay_total;
