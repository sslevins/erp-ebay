 ...
 ?>
	<div style="width:76mm;height:54mm;float:left;border:2px solid #000000;padding:2mm;font-size:12px; margin:0px 20px;">
		...
		<div style='width:100%; position:relative'>
			<div style='width:95%;float:left; font-size:14px; overflow:hidden;'>
				<ul style="margin-left:5px;">
					<li style="width:100%; height:4mm; line-height:4mm"><strong>TO:<span style='margin-left:10px;'><?php echo $name; ?></span></strong></li>
