   ...
   <?php
 	for($i=0;$i<count($sql);$i++){
				...
				$countryname 	= $sql[$i]['ebay_countryname'];
					...
					$ss				= "select * from ebay_countrys where  countrysn ='$countryname' and ebay_user ='$user'";					
					$ss				= $dbcon->execute($ss);
					$ss				= $dbcon->getResultArray($ss);
					$countryname    = $ss[0]['countryen'];
					
				$countrycn    = $ss[0]['countrycn'];
...
<div style="width:98mm;height:98mm;font-size:16px;float:left;margin:1px; padding:1mm">

<div style="width:98mm;height:42mm;background-corlor:White;margin-top:10px;line-height:6mm">     
...
<img src="barcode128.class.php?data=<?php echo $ebay_id;?>"  width="250px" height="50px"/>
</div>
<div style="width:68mm;height:6mm;margin-left:80px; ">  
<?php echo "*".$ebay_id."*";?>  

</div>
<div style="width:68mm;height:26mm;margin-bottom:10px; border-top:1px dashed #000000">   
<?php 
