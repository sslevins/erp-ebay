      ...
      <tr>
        ...
        <td><div align="right">
          <table width="100%" border="0" cellspacing="0" cellpadding="1" style="border-bottom:5px #000000 solid">
            <tr>
              <td><img src="barcode128.class.php?data=<?php echo $ebay_id;?>" alt="" width="143" height="38" />    <?php echo $ebay_id;?></td>
		...
		?>
          ...
          <tr>
            ...
            <?php if($ebay_id > 0 ){ ?>            <?php } ?>            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="13%" rowspan="3"><span class="STYLE8"><img src="<?php echo $ebay_itemurl; ?>" width="76" height="70" />&nbsp;</span></td>
                <td width="60%"><span class="STYLE8">SKU:<?php echo $sku;?></span></td>
                <td width="27%"><span class="STYLE8">数量：<?php echo $amount;?></span></td>
              </tr>
              <tr>
                <td><span class="STYLE8">颜色/尺寸<?php echo $attribute; ?></span></td>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="12%" rowspan="3"><span class="STYLE8"><img src="<?php echo $ebay_itemurl; ?>" alt="" width="76" height="70" />&nbsp;</span></td>
                <td width="61%"><span class="STYLE8">SKU:<?php echo $sku;?></span></td>
                <td width="27%"><span class="STYLE8">数量：<?php echo $amount;?></span></td>
              </tr>
              <tr>
                <td><span class="STYLE8">颜色/尺寸<?php echo $attribute; ?></span></td>
