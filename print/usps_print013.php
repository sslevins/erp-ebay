...
$pdf->SetTopMargin(2);
	...
	for($i=0;$i<count($sql);$i++){
				...
				$i++;
				$currentpage++;
				$ebay_tracknumber					= $sql[$i]['ebay_tracknumber']?$sql[$i]['ebay_tracknumber']:'blank';
    			...
    			<td><img src="'.$img1.'" width="280" height="395">&nbsp;</td>
				 </tr><tr>
  				  <td><img src="'.$img2.'" width="280" height="395">&nbsp;</td>
    			<td><img src="'.$img3.'" width="280" height="395">&nbsp;</td>
				</tr></table';
