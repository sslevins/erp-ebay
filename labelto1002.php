...
$objPHPExcel->getProperties()->setCreator("Maarten Balliauw")
	...
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('C1', '外包装件数');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('D1', '重量');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('E1', '中转渠道');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('F1', '寄件人公司或人名');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('G1', '寄件人地址');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('H1', '收件人邮箱');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('I1', '收件人电话');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('J1', '收件人公司名');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('K1', '收件人姓名');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('L1', '收件人地址');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('M1', '到达国家');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('N1', '申报品名1');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('O1', 'Q数量1');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('P1', '币种');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('Q1', '报价1');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('R1', '申报品名2');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('S1', '数量2');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('T1', '报价2');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('U1', '总值');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('V1', '是否保险');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('W1', '自定义配货信息1');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('X1', '自定义配货信息2');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('Y1', 'USER ID');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('Z1', '挂号条码');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AA1', ' 订单编号');
	...
	for($i=0;$i<count($sql);$i++){
		...
		$usernamet		= $ss[0]['username'];
		$addresst		= $ss[0]['address'];
		...
		for($o=0;$o<count($sl);$o++){					
			...
			$qty	+= $amount;
			$tprice	+= $ebay_itemprice;



			
			
			if($attribute != '')     $strlinestr				 .= '('.$attribute.')';
			...
			$totalsbjz			+= ($goods_sbjz * $ebay_amount);
			
			$strlinestr				 .= $sku1.' '.$notes.' * '.$amount.' '.$goods_location.' '.$goods_name.' ; ';
				...
				$goods_name			= $sq3[0]['goods_name'];
				$goods_location		= $sq3[0]['goods_location'];
				$totalsbjz			+= ($goods_sbjz * $goddscount);
				
				$strlinestr				 .= $sku1.' '.$notes.' * '.$goddscount.' '.$goods_location.' '.$goods_name.' ; ';
		...
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('B'.$a, $appname.$recordnumber0, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('E'.$a, $ebay_carrier, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('F'.$a, $usernamet, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('G'.$a, $addresst, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('H'.$a, $ebay_usermail, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('I'.$a, $tel, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('K'.$a, $name, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('L'.$a, $addressline, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('M'.$a, $countryname, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('N'.$a, $tywsbmc, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('O'.$a, $qty, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('P'.$a, $ebay_currency, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('Q'.$a, $tt0, PHPExcel_Cell_DataType::TYPE_STRING);
				
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('U'.$a, $totalsbjz, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('W'.$a, $strlinestr, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('Y'.$a, $ebay_userid, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('Z'.$a, $ebay_tracknumber, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('AA'.$a, $ebay_id, PHPExcel_Cell_DataType::TYPE_STRING);
...
$objPHPExcel->setActiveSheetIndex(0)->getColumnDimension('N')->setWidth(5);
...
$title		= "4px".date('Y-m-d');
$titlename		= "4px".date('Y-m-d').".xls";
