...
<table cellpadding='0' cellspacing='0' width='100%' border='0' class='list view'>
	...
	//	echo $firstday." && ".$firstdaysend."<br>";
			...
			$sql			= "select sum(net) as net,sum(fee) as fee, sum(gross) as gross from ebay_paypaldetail where time>=$ss and time<=$ee ";
		
			
			if($account != 'all') $sql .= "  and account='$account' ";
			$sql			.= " and user ='$user' ";
...
?>
        ...
        <img src="libchart/<?php echo "$filename"; ?>" />&nbsp;</td>
	</tr>
...
<script language="javascript">
	...
	function changedate(){
		...
		location.href = 'paypalstaticschat.php?type=changedate&date='+date+"&module=finance&action=Paypal销售额统计&account="+account;
