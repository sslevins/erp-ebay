...
$objPHPExcel->getProperties()->setCreator("Maarten Balliauw")
	...
	for($i=0;$i<count($sql);$i++){
		...
		//	$linstr			= $ebayaccount.$recordnumber0."-".($o+1);
			...
			$linstr			= $appname.''.$recordnumber0;
			
			
			$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('A'.$a, $linstr, PHPExcel_Cell_DataType::TYPE_STRING);
			...
			$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('N'.$a, $sku1.' // '.$goods_name, PHPExcel_Cell_DataType::TYPE_STRING);
			$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('O'.$a, $amount, PHPExcel_Cell_DataType::TYPE_STRING);
			$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('P'.$a, $ebay_itemprice, PHPExcel_Cell_DataType::TYPE_STRING);
			$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('U'.$a, $ebay_total, PHPExcel_Cell_DataType::TYPE_STRING);
