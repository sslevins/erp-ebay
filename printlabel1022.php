...
<div style="width:80mm;height:60mm;border:2px solid black;font-size:12px;float:left;margin:1px;">
...
<div style="width:80mm;height:10mm;text-align:left;">
<img src="barcode128.class.php?data=<?php echo $ebay_id;?>"  width="180px" height="30px" ;"/>
 <?php echo "(".$ebayaccount.")";?>

</div>
<div style="width:80mm;height:4mm;margin-left:30px; ">  
<?php echo "*".$ebay_id."*";?>  
