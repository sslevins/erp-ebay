...
$objPHPExcel->getProperties()->setCreator("Maarten Balliauw")
	...
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('A1', 'Order Number');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('B1', 'Delivery Status');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('C1', 'Logistics Company');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('D1', 'Tranking Number');
	...
	for($i=0;$i<count($sql);$i++){
		...
		$track_number			= @$sql[$i]['ebay_tracknumber'];
		...
		if($ebay_carrier == 'EMS' ) $ebay_carrier = 'EMS';
		if($ebay_carrier == 'EUB' ) $ebay_carrier = 'ePacket';
		if($ebay_carrier == 'DHL' ) $ebay_carrier = 'DHL';
		if($ebay_carrier == 'CN挂号' ) $ebay_carrier = 'China Post Air Mail';
		if($ebay_carrier == 'HK挂号' ) $ebay_carrier = '	Hongkong Post Air Mail';
		
		
		$gshdate				= date('Y/n/d',strtotime(date('Y-m-d')));
		...
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('A'.$a, $recordnumber0, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('B'.$a, 'Full Shipment', PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('C'.$a, $ebay_carrier, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('D'.$a, $track_number, PHPExcel_Cell_DataType::TYPE_STRING);
...
$objPHPExcel->setActiveSheetIndex(0)->getStyle('A1:N500')->getAlignment()->setVertical(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
