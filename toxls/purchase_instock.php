				...
				$sql = $sql.$limit;
				  ...
				  ?>
					<tr height='20' class='oddListRowS1'>
						    ...
						    <td scope='row' align='left' valign="top" ><a href="purchaseorderaddv3.php?storeid=<?php echo $id; ?>&module=purchase&action=入库&io_ordersn=<?php echo $io_ordersn;?>&stype=<?php echo $stype; ?>" target="_parent">编辑计划单</a>
