...
$objPHPExcel->getProperties()->setCreator("Maarten Balliauw")
	...
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('B1', 'order-item-id');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('C1', 'quantity');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('D1', 'ship-date');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('E1', 'carrier-code');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('F1', 'carrier-name');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('G1', 'tracking-number');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('H1', 'ship-method');
	...
	for($i=0;$i<count($sql);$i++){
			...
			for($v=0;$v<count($vv);$v++){
				...
				$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('A'.$a, $ebay_ordersn, PHPExcel_Cell_DataType::TYPE_STRING);
				$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('B'.$a, $recordnumber, PHPExcel_Cell_DataType::TYPE_STRING);
				$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('C'.$a, $ebay_amount, PHPExcel_Cell_DataType::TYPE_STRING);
				$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('D'.$a, $ssdate, PHPExcel_Cell_DataType::TYPE_STRING);
				...
				$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('G'.$a, $ebay_tracknumber, PHPExcel_Cell_DataType::TYPE_STRING);
