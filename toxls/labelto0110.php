...
$objPHPExcel->getProperties()->setCreator("Maarten Balliauw")
	...
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('E1', 'name');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('F1', 'street');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('G1', 'state');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('H1', 'city');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('I1', 'zip code');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('J1', 'Tracking');
	...
	for($i=0;$i<count($sql);$i++){
		...
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('B'.$a, $gshdate, PHPExcel_Cell_DataType::TYPE_STRING);
		//$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('C'.$a, 'jersey 2', PHPExcel_Cell_DataType::TYPE_STRING);
