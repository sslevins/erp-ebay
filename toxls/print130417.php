...
//idPrint3.disabled = false; 
   ...
   <?php
 	for($i=0;$i<count($sql);$i++){
				...
				$ebay_noteb		= $sql[$i]['ebay_noteb'].$ebay_note;
...
<div style="text-align:left; margin-left:60px"><strong>Tracking Number<br />
<?php echo $ebay_tracknumber;?></strong></div>
<div style="text-align:left; border-top:1px double #000000;"><strong style=" font-size:22px"></strong><span></span>





<img src="../barcode128.class.php?data=<?php echo $ebay_tracknumber;?>"  style="margin-top:5px" width="251" height="39"/>

<?php } ?>


</div>
<div style="width:98mm;height:35mm;background-corlor:White;margin-top:10px;line-height:6mm">     
...
<div style="height:20mm;margin-bottom:10px; border-top:1px  double #000000; font-size:13px">   
<?php 
