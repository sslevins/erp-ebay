...
$objPHPExcel->getProperties()->setCreator("Maarten Balliauw")
	...
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('B1', '发货地址');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('C1', '物品编码名称和数量');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('D1', '图片');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('E1', '备注');
	...
	for($i=0;$i<count($sql);$i++){
		...
		$objPHPExcel->setActiveSheetIndex(0)->getCell('E'.$a)->setValueExplicit("Total:".$totalprice, PHPExcel_Cell_DataType::TYPE_STRING);
...
$objPHPExcel->setActiveSheetIndex(0)->getStyle('D1:D500')->getFont()->setSize(8);
...
$objPHPExcel->getSheet(1)->setTitle('Print address');
	...
	for($i=0;$i<count($sql);$i++){
		...
		if($i%2 == 0){
			...
			$objPHPExcel->setActiveSheetIndex(1)->getCell('A'.$b)->setValueExplicit('To '.$lstr, PHPExcel_Cell_DataType::TYPE_STRING);
			$objPHPExcel->setActiveSheetIndex(1)->getCell('B'.$b)->setValueExplicit($times, PHPExcel_Cell_DataType::TYPE_STRING);
			$objPHPExcel->setActiveSheetIndex(1)->getCell('C'.$b)->setValueExplicit($headstr.($i+1), PHPExcel_Cell_DataType::TYPE_STRING);
			...
			$objPHPExcel->setActiveSheetIndex(1)->getRowDimension($b+1)->setRowHeight(119.75);	
			...
			$str	= 'D'.($bb+1).':F'.($bb+1);
			$objPHPExcel->setActiveSheetIndex(1)->getCell('D'.$bb)->setValueExplicit('To'.$lstr, PHPExcel_Cell_DataType::TYPE_STRING);
			$objPHPExcel->setActiveSheetIndex(1)->getCell('E'.$bb)->setValueExplicit($times, PHPExcel_Cell_DataType::TYPE_STRING);
			$objPHPExcel->setActiveSheetIndex(1)->getCell('F'.$bb)->setValueExplicit($headstr.($i+1), PHPExcel_Cell_DataType::TYPE_STRING);
			$objPHPExcel->setActiveSheetIndex(1)->mergeCells($str);
			$objPHPExcel->setActiveSheetIndex(1)->getCell('D'.($bb+1))->setValueExplicit($addressline, PHPExcel_Cell_DataType::TYPE_STRING);
			$objPHPExcel->setActiveSheetIndex(1)->getRowDimension($bb+1)->setRowHeight(119.75);	
