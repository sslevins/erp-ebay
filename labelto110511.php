...
$objPHPExcel->getProperties()->setCreator("Maarten Balliauw")
	...
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('I1', '帐号');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('J1', 'Buyer Full Name');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('K1', 'Country');
	...
	for($i=0;$i<count($sql);$i++){
		...
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('J'.$a, $name, PHPExcel_Cell_DataType::TYPE_STRING);
