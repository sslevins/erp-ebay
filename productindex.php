...
<table cellpadding='0' cellspacing='0' width='100%' border='0' class='list view'>
  ...
  <th scope='col' nowrap="nowrap">
		...
		<th scope='col' nowrap="nowrap">英文名称</th>
		...
		<th scope='col' nowrap="nowrap">单位&nbsp;</th>
					<th scope='col' nowrap="nowrap">货位&nbsp;</th>
        ...
        <th scope='col' nowrap="nowrap">操作</th>
			  ...
			  <?php
				...
				if($searchs == '3'){
				 $sql	.= " and a.goods_unit = '$keys' ";
				}
				
				if($searchs == '4'){
				 $sql	.= " and a.goods_location = '$keys' ";
				}
				...
				for($i=0;$i<count($sql);$i++){
					...
					if($goods_pic == '' ) $goods_pic = $goods_sn.'.jpg';
					
					
			//		echo $goods_sn.filesize('images/'.$goods_pic).'<br>';
					
					
			
					$isuse			= $sql[$i]['isuse'];
					$ispacking				= $sql[$i]['ispacking']?"是":'否';
					$ebay_packingmaterial	= $sql[$i]['ebay_packingmaterial'];
					$goods_enname			= $sql[$i]['goods_enname'];
			  ...
			  ?>
         		...
         		<tr height='20' class='oddListRowS1'>
						<td scope='row' align='left' valign="top" ><input name="ordersn" type="checkbox" id="ordersn" value="<?php echo $goods_id;?>" ></td>
							...
							if($user != 'vipyisi' && $user != 'vipchi'){
							 ?>
                           <a href="images/<?php echo $goods_pic; ?>" target="_blank"> <img src="images/<?php echo $goods_pic; ?>" width="50" height="50" /></a>
                            <?php }else{ ?>
						    ...
						    <td scope='row' align='left' valign="top" ><?php echo $goods_enname;?>&nbsp;</td>
						    <td scope='row' align='left' valign="top" >
...
<?php
                  ...
                  &nbsp;</td>
						    ...
						    <td scope='row' align='left' valign="top" ><?php echo $ispacking;?>&nbsp;</td>
						    <td scope='row' align='left' valign="top" ><a href="#" onclick="viewsales('<?php echo $goods_sn;?>')" >查看销量</a>&nbsp;
                              ...
                              <a href="printskulabel001.php?sku=<?php echo $goods_sn;?>&&module=warehouse&action=" target="_blank">打码
                              </a>
                            &nbsp; </td>
	  </tr>
