<?php
	...
	$country['Zimbabwe']				=	'津巴布韦';
		...
		$ertj		= "";
			...
			$sql			= "select a.*,b.sku from ebay_order as a join ebay_orderdetail as b on a.ebay_ordersn=b.ebay_ordersn where a.ebay_userid !='' and ($ertj) group by a.ebay_id order by b.ebay_id  asc ";
...
<?php
  ...
  <tr>   
    ...
    <table width="100%" height="100" border="0" cellpadding="0" cellspacing="0" style="border:1px dashed #999999">
      ...
      <tr >
        <td style="border-bottom:1px #000 dotted ; border-bottom-color:#000">OrdersId:<?php echo $ebay_id;?></td>
      </tr>
      <tr>
        <td style="border-bottom:1px #000 dotted ; border-bottom-color:#000">Concact Name:<?php echo $cname;?></td>
      </tr>
      <tr>
        <td style="border-bottom:1px #000 dotted ; border-bottom-color:#000">Address:<?php echo $street1.' '.$street2.' '.$city.' '.$state.' ';?></td>
      </tr>
      <tr>
        <td style="border-bottom:1px #000 dotted ; border-bottom-color:#000">Country:<?php echo $countryname;?></td>
      </tr>
      <tr>
        <td style="border-bottom:1px #000 dotted ; border-bottom-color:#000">Postal Code:<?php echo $zip;?></td>
      </tr>
      <tr>
        <td style="border-bottom:1px #000 dotted ; border-bottom-color:#000">Phone Number:<?php echo $tel;?></td>
      </tr>
      <tr>
        <td style="border-bottom:1px #000 dotted ; border-bottom-color:#000">Mobile:<?php echo $tel;?></td>
      </tr>
