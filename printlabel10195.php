...
<div style="width:102mm; font-family: arial;">
<?php
...
$Shipping		= $_REQUEST['Shipping'];
	...
	if($ostatus!=='100')
	 ...
	 if($Shipping!='')
		...
		$sql			= "select a.* from ebay_order as a join ebay_orderdetail as b on a.ebay_ordersn=b.ebay_ordersn where  ($tj)  group by a.ebay_id ";
	}	
 ...
 ?>
	<div style="width:96mm;height:96mm;float:left;border:2px solid #000000;padding:2mm;font-size:12px; margin:2px 1px">

		<div style="width:100%;height:30mm;padding-top:6mm;">
			<div style="width:50%;height:24mm;float:left;">
				<ul style="width:100%;">
					<li style="width:100%; height:5mm; line-height:5mm">Return Address:<?php echo $fromuser;?></li>
					<li style="width:100%; height:5mm; line-height:5mm"><?php echo $address[0];?></li>
					<li style="width:100%; height:5mm; line-height:5mm"><?php echo $address[1];?></li>
					<li style="width:100%; height:5mm; line-height:5mm"><?php echo $address[2];?></li>
				</ul>
		  </div>
			<div style="width:49%;height:16mm;float:right">
				<div style="width:99%;height:96%; border:1px solid #000000;font-size:14px;text-align:center">
					<div style="float:left;width:5%; height:100%; line-height:15mm; border-right:1px solid #000000">
						1
					</div>
					<div style="float:left;width:57%; height:100%; line-height:5mm; border-right:1px solid #000000;">
						POSTAGE<br>
						PAID<br>
						HONG KONG
					</div>
					<div style="float:left;width:35%; height:100%; line-height:5mm;">
						PERMIT<br>
						NO.<br>
		...
		<div style='width:100%; position:relative'>
			<div style='width:95%;float:left; font-size:16px; overflow:hidden;'>
				<ul style="margin-left:5px;">
					<li style="width:100%; height:6mm; line-height:6mm"><strong>TO:<span style='margin-left:10px;'><?php echo $name; ?></span></strong></li>
					<li style="width:100%; height:6mm; line-height:6mm"><strong>TEL: </strong><span style='font-size:14px'><?php echo $tel;?></span></li>
					<li style="width:100%; height:6mm; line-height:6mm"><span style='margin-left:40px; font-size:14px'><?php echo $street;?></span></li>
					<li style="width:100%; height:6mm; line-height:6mm"><span style='margin-left:40px; font-size:14px'><?php echo $citystate;?></span></li>
					<li style="width:100%; height:6mm; line-height:6mm"><span style='margin-left:40px; font-size:14px'><?php echo $zip;?></span></li>
					<li style="width:100%; height:6mm; line-height:6mm"><span style='margin-left:40px;'><strong><?php echo $countryname?></strong></span></li><br />

<img src="barcode128.class.php?data=<?php echo $ebay_id; ?>" alt="" width="137" height="36"/><br />
<?php echo $ebay_id; ?>
				</ul>
			</div>
	...
	<div style="width:96mm;height:80mm;float:left;border:2px solid #000000;padding:2mm;font-size:12px; margin:2px 1px">
			<?php
						...
						$goods_name = $rr[0]['notes'];
									...
									for($e=0;$e<count($goods_sncombine);$e++){
											...
											$goods_name		=  '';
												  ...
												  $aa = $aa+1;
					echo '<strong>-'.$goods_sn.' '.$goods_name.' ('.$goddscount.');</strong>';
					if($aa%2==0){
						echo '<br>';
					}
					  ...
					  $goods_name = ''.' '.$uu[0]['notes'];
					  
					  
					  $aa = $aa+1;
					echo '<strong>-'.$sku.' '.$goods_name.' ('.$ebay_amount.');</strong>';
					if($aa%2==0){
						echo '<br>';
					}
