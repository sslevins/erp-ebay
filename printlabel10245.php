...
<table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
  <tr height="24">
    <td align="center"><span class="styleth">客户姓名</span></td>
    <td align="center"><span class="styleth">物品</span></td>
  ...
  for($i=0;$i<count($sql);$i++){
	   ...
	   for($g=0;$g<count($ss);$g++)
	   {
			...
			$ebay_itemtitle			= substr($ebay_itemtitle,strlen($ebay_itemtitle) - 20 );
  ...
  ?>
  <tr>
    <td style="padding-left:2px;"><span class="STYLE4"><?php echo $ebay_username?>&nbsp;</span></td>
    <td align="center"><span class="style14b"><?php echo $ebay_itemtitle;?>&nbsp;</span></td>
