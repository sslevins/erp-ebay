...
&nbsp;</td>
            ...
            <tr>
              <td>Name:</td>
              <td width="73%"><?php echo $sendusername;?>&nbsp;</td>
            </tr>
            <tr>
              <td>寄货人/&nbsp;</td>
...
&nbsp;</td>
            ...
            <tr>
              <td colspan="2">RECEIVER'S  INFORMATION    收件人资料</td>
              </tr>
            <tr>
              <td>Name:</td>
              <td><?php echo $name;?>&nbsp;</td>
            ...
            <tr>
              <td>电话</td>
              <td><span style="border-right: #000000 solid 1px;border-left:#000000 solid 1px"><?php echo $tel;?></span></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
          ...
          <td valign="top"><table width="100%" border="0" cellspacing="0">
            <tr>
              <td colspan="2">TRACKING NUMBER  运单号码</td>
              </tr>
            <tr>
              <td colspan="2">CT263022365CN</td>
              </tr>
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
