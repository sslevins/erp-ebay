...
include "top.php";
	...
	if($type == "del"){
		...
		$id	 = $_REQUEST['id'];
		$sql = "delete from ebay_cppycalcfee where id=$id";
...
<tr>
	...
	<input tabindex='2' title='添加新的发货方式' class='button' type="button" name='button' value='添加' id='search_form_submit' onClick="location.href='cppyshipfee.php?module=system&action=中国邮政平邮'"/>
	&nbsp;<br /></td>
	</tr>
</table>
</div>
...
<table cellpadding='0' cellspacing='0' width='100%' border='0' class='list view'>
   ...
   <?php 
				  	...
				  	$sql = "select * from ebay_cppycalcfee where ebay_user='$user' ";
		...
		$id			= $sql[$i]['id'];
				  ...
				  ?>
						...
						<td scope='row' align='left' valign="top" ><?php echo $id; ?></td>
						    ...
						    <td scope='row' align='left' valign="top" ><a href="cppyshipfee.php?id=<?php echo $id; ?>&module=system&action=发货方式管理">修改</a> <a href="#" onClick="del(<?php echo $id; ?>)">删除</a>&nbsp;</td>
			  </tr>
...
<script language="javascript">
	...
	function del(id){
		if(confirm('您确认删除此条记录吗')){
			...
			location.href = 'cppyshipfeelist.php?type=del&id='+id+"&module=system&action=运费设置";
