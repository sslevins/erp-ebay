...
$dbcon	= new DBClass();
	...
	for($i=0;$i<count($sql);$i++){
		...
		$values[$a][0] = '4;;;yoyoBey Almacen;C/alcala 414 C.C.alcala norte bajo 59 ;28027;Madrid;Madrid;España;911693209;;yoyobey;info@yoybey.com';
		$values[$a][1] = $strline;
		$a++;
}
$fp = fopen('images/xibanya48-72.csv', 'w');
 foreach($values as $k=>$v){
	 fputcsv($fp,$v);
 }
 fclose($fp);
 Header("Location:images/xibanya48-72.csv"); 
exit;
