...
$objPHPExcel->getProperties()->setCreator("Maarten Balliauw")
	...
	$sql1	= "select sku,sum(b.ebay_amount) from ebay_order as a join ebay_orderdetail as b on a.ebay_ordersn = b.ebay_ordersn where a.ebay_user='$user' and a.ebay_status='0' and a.ebay_combine!='1' ";
	...
	if($country != ''){
		...
		$sql1   .= " and a.ebay_countryname='$country' GROUP BY b.sku ORDER BY b.sku";
