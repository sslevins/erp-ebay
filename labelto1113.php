...
$objPHPExcel->getProperties()->setCreator("Maarten Balliauw")
	...
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('C1', '客户邮箱');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('D1', 'SKU*数量');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('E1', '产品标题');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('F1', '图片');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('G1', 'Paypal买家留言');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('H1', '买家Paypal地址');
	...
	for($i=0;$i<count($sql);$i++){
		...
		$objPHPExcel->setActiveSheetIndex(0)->getCell('B'.$a)->setValueExplicit($strline3, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->getCell('C'.$a)->setValueExplicit($ebay_usermail, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->getCell('D'.$a)->setValueExplicit($strline2, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->getCell('E'.$a)->setValueExplicit($strline, PHPExcel_Cell_DataType::TYPE_STRING);
		
		$objPHPExcel->setActiveSheetIndex(0)->getCell('G'.$a)->setValueExplicit($ebay_note, PHPExcel_Cell_DataType::TYPE_STRING);
