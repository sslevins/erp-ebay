...
$id		= $_REQUEST['id'];
if($id != ''){
$sql		= "delete  from  ebay_zen where id='$id'";
...
<tr>
	...
	<td nowrap="nowrap" scope="row" ><!--
	  ...
	  <input type="button" value="添加新的网店(仅支持zencart)" onclick="location.href='systemzencartadd.php?module=system'" /></td>
</tr>
</table>
  ...
  <th scope='col' nowrap="nowrap"><div align="left">数据库服务器地址</div></th>
        ...
        <th scope='col' nowrap="nowrap">操作</th>
			  ...
			  <?php				
				...
				$sql		= "select * from ebay_zen as a where user='$user'";
			  ...
			  ?>
         		...
         		<tr height='20' class='oddListRowS1'>
                  ...
                  <a href="systemzencartadd.php?id=<?php echo $id; ?>&module=system">修改</a>
...
<script language="javascript">
	...
	function deleterows(id){
			...
			if(confirm("确认删除此条记录吗")){
				...
				location.href	= 'systemzencart.php?id='+id+"&module=system";
