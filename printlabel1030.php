...
<div style="width:84mm; font-family: arial;">
<?php
...
$Shipping		= $_REQUEST['Shipping'];
	...
	if($ostatus!=='100')
	 ...
	 if($Shipping!='')
		...
		$sql			= "select * from ebay_order as a join ebay_orderdetail as b on a.ebay_ordersn=b.ebay_ordersn where ebay_userid !='' and ($tj)  ";
	}	
 ...
 ?>
	<div style="width:76mm;height:54mm;float:left;border:2px solid #000000;padding:2mm;font-size:12px; margin:0px 20px;">
		<div style="width:100%;height:9mm;border-left:1px dashed #000000;border-right:1px dashed #000000;border-bottom:1px solid #000000">
			<?php
				...
				foreach($ee as $key=>$val){
					...
					echo '<strong>-'.$sku.' '.$goods_name.' 共'.$ebay_amount.'件;</strong><br>';
				}
			?>
		</div>
		...
		<div style="width:100%;height:16mm;padding-top:2mm;">
			<div style="width:55%;height:13mm;float:left;">
				<ul style="width:100%;">
					<li style="width:100%; height:3mm; line-height:3mm">From:<?php echo $fromuser;?></li>
					<li style="width:100%; height:3mm; line-height:3mm"><?php echo $address[0];?></li>
					<li style="width:100%; height:3mm; line-height:3mm"><?php echo $address[1];?></li>
					<li style="width:100%; height:3mm; line-height:3mm"><?php echo $address[2];?></li>
				</ul>
			</div>
			<div style="width:45%;height:10mm;float:right">
				<div style="width:99%;height:96%; border:1px solid #000000;font-size:10px;text-align:center">
					<div style="float:left;width:5%; height:100%; line-height:9mm; border-right:1px solid #000000">
						1
					</div>
					<div style="float:left;width:57%; height:100%; line-height:3mm; border-right:1px solid #000000;">
						POSTAGE<br>
						PAID<br>
						HONG KONG
					</div>
					<div style="float:left;width:35%; height:100%; line-height:3mm;">
						PERMIT<br>
						NO.<br>
		...
		<div style='width:100%; position:relative'>
			<div style='width:95%;float:left; font-size:16px; overflow:hidden;'>
				<ul style="margin-left:5px;">
					<li style="width:100%; height:4mm; line-height:4mm"><strong>TO:<span style='margin-left:5px;'><?php echo $name; ?></span></strong></li>
					<li style="width:100%; height:4mm; line-height:4mm"><strong>TEL:</strong><span style='font-size:12px'><?php echo $tel;?></span></li>
					<li style="width:100%; height:4mm; line-height:4mm"><span style='margin-left:38px; font-size:12px'><?php echo $street;?></span></li>
					<li style="width:100%; height:4mm; line-height:4mm"><span style='margin-left:38px; font-size:12px'><?php echo $citystate;?></span></li>
					<li style="width:100%; height:4mm; line-height:4mm"><span style='margin-left:38px; font-size:12px'><?php echo $zip;?></span></li>
					<li style="width:100%; height:4mm; line-height:4mm"><span style='margin-left:38px;'><strong><?php echo $countryname?></strong></span></li>
				</ul>
			</div>
			
			<div style='width:120px; height:20px; position:absolute; bottom:-6px; right:2px;text-align:center;font-size:14px; padding-top:1px'>
