...
$objPHPExcel->getProperties()->setCreator("Maarten Balliauw")
	...
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('C1', 'Buyer Full name');
	...
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('I1', 'Buyer County');
	...
	for($i=0;$i<count($sql);$i++){
		...
		$vv		= "select * from ebay_carrier where name ='$ebay_carrier' and ebay_user ='$user' ";
		$vv		= $dbcon->execute($vv);
		$vv		= $dbcon->getResultArray($vv);
		$ebay_carrier		= $vv[0]['value'];
		...
		for($o=0;$o<count($sl);$o++){
					...
					if(count($rr) > 0){
						...
						$labelstr			= substr($labelstr,0,strlen($labelstr) -1 );
						...
						$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('C'.$a, $name, PHPExcel_Cell_DataType::TYPE_STRING);
						...
						$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('H'.$a, $city, PHPExcel_Cell_DataType::TYPE_STRING);
						$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('I'.$a, $state, PHPExcel_Cell_DataType::TYPE_STRING);
						$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('J'.$a, $zip, PHPExcel_Cell_DataType::TYPE_STRING);
						$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('K'.$a, $countryname, PHPExcel_Cell_DataType::TYPE_STRING);
						$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('L'.$a, $ebay_itemid, PHPExcel_Cell_DataType::TYPE_STRING);
						$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('N'.$a, $labelstr, PHPExcel_Cell_DataType::TYPE_STRING);
						$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('O'.$a, $totalqty, PHPExcel_Cell_DataType::TYPE_STRING);
						$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('V'.$a, 'Paypal', PHPExcel_Cell_DataType::TYPE_STRING);
						$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('AG'.$a, $ebay_carrier, PHPExcel_Cell_DataType::TYPE_STRING);
