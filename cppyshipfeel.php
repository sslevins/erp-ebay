...
include "top.php";
	...
	if($_POST['submit']){
			...
			$sql	= "insert into ebay_emscalcfee(firstweight,nextweight,discount,countrys,name,ebay_user) values('$firstweight','$nextweight','$discount','$countrys','$name','$user')";
			
			
			}else{
			
			$sql	= "update ebay_emscalcfee set firstweight='$firstweight',nextweight='$nextweight',discount='$discount',countrys='$countrys',name='$name' where id=$id";
			}
