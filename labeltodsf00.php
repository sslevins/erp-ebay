...
$objPHPExcel->getProperties()->setCreator("Maarten Balliauw")
	...
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('A1', 'Customer Number');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('B1', '4px Product');
	...
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('L1', 'Buyer Zip');
	...
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('Q1', 'isreturn');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('R1', 'category');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('S1', 'Quantity');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('T1', 'Sale Price');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('U1', 'Shipping and Handling');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('V1', 'US Tax');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('W1', 'Insurance');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('X1', 'Total Price');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('Y1', 'Payment Method');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('Z1', 'Sale Date');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AA1', 'Checkout Date');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AB1', 'Paid on Date');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AC1', 'Shipped on Date');
	...
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AG1', 'Listed On');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AH1', 'Sold On');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AI1', 'PayPal Transaction ID');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AJ1', 'Shipping Service');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AK1', 'Transaction ID');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AL1', 'Order ID');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AM1', 'declared value');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AN1', 'weight');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AO1', 'isreturn');
	...
	for($i=0;$i<count($sql);$i++){
		...
		//	$linstr			= $ebayaccount.$recordnumber0."-".($o+1);
			
			
			$ebaytoo		= number_format($amount*$ebay_itemprice,2);
			$linstr			= $appname.'_'.$recordnumber;
			
			
			$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('B'.$a, '香港小包平邮', PHPExcel_Cell_DataType::TYPE_STRING);
			$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('C'.$a, $linstr, PHPExcel_Cell_DataType::TYPE_STRING);
			$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('D'.$a, $ebay_userid, PHPExcel_Cell_DataType::TYPE_STRING);
			$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('E'.$a, $name, PHPExcel_Cell_DataType::TYPE_STRING);
			$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('F'.$a, $ebay_phone, PHPExcel_Cell_DataType::TYPE_STRING);
			$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('G'.$a, $ebay_usermail, PHPExcel_Cell_DataType::TYPE_STRING);
			$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('H'.$a, $street1, PHPExcel_Cell_DataType::TYPE_STRING);
			...
			$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('N'.$a, $ebay_itemid, PHPExcel_Cell_DataType::TYPE_STRING);
			$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('O'.$a, $sku, PHPExcel_Cell_DataType::TYPE_STRING);
			$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('P'.$a, $sku1.' // '.$goods_name, PHPExcel_Cell_DataType::TYPE_STRING);
			$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('S'.$a, $amount, PHPExcel_Cell_DataType::TYPE_STRING);
			$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('T'.$a, $ebay_itemprice, PHPExcel_Cell_DataType::TYPE_STRING);
			$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('U'.$a, $ebay_shipfee, PHPExcel_Cell_DataType::TYPE_STRING);
			
			$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('X'.$a, $ebaytoo, PHPExcel_Cell_DataType::TYPE_STRING);
			$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('AM'.$a, '1', PHPExcel_Cell_DataType::TYPE_STRING);
			$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('AJ'.$a, $ebay_carrier, PHPExcel_Cell_DataType::TYPE_STRING);
