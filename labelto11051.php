...
$objPHPExcel->getProperties()->setCreator("Maarten Balliauw")
	...
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('D1', 'Item Number');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('E1', 'SKU');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('F1', 'Quantity');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('G1', 'Sale Price');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('H1', 'Total Price');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('I1', 'Shipped on Date');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('J1', 'Label');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('K1', 'Buyer Email');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('L1', 'Shipping Service');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('M1', 'Tracking number');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('N1', '重量');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('O1', '邮费');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('P1', '账号');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('Q1', '跟踪号');
	...
	for($i=0;$i<count($sql);$i++){
		...
		$ShippedTime			= $sql[$i]['ShippedTime']?date('M-d-y',$sql[$i]['ShippedTime']):'';
		...
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('C'.$a, $ebay_userid, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('D'.$a, $ebay_itemid, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('E'.$a, $sku, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('F'.$a, $amount, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('G'.$a, $ebay_currency.$ebay_itemprice, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('H'.$a, $ebay_currency.$ebay_total, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('I'.$a, $ShippedTime, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('J'.$a, $addressline, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('K'.$a, $ebay_usermail, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('L'.$a, $ebay_carrier, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('M'.$a, $ebay_tracknumber, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('N'.$a, $goods_weight, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('O'.$a, $shipfee, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('P'.$a, $ebay_account, PHPExcel_Cell_DataType::TYPE_STRING);

		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('Q'.$a, $ebay_tracknumber, PHPExcel_Cell_DataType::TYPE_STRING);
