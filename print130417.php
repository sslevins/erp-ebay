...
<html>
 <body>
 <div style="width:100mm;background-corlor:White;font-size:14px;"> 
<?php
	error_reporting(0);
	...
	$ie=1;
		...
		$ertj		= "";
			...
			$sql	= "select a.*,count(b.ebay_id) as cc  from ebay_order as a join ebay_orderdetail as b on a.ebay_ordersn = b.ebay_ordersn  where ($ertj) and a.ebay_user='$user' group by a.ebay_id  order by  sku asc ";
...
<div style="width:98mm;height:90mm;font-size:16px;float:left;margin:1px; padding:1mm">

<div style="width:98mm;height:45mm;background-corlor:White;margin-top:10px;line-height:6mm">     
          
        <p><span style="font-size:9px; line-height:10px; margin-bottom:0px" >From:   sun you LogisticsLimited</span></p>
        <p><span style="font-size:9px; line-height:10px; margin-bottom:0px" > P.O,Box No.91629<br>Tsim Sha Tsui Post Office Hong Kong</span><br />
        </p>

        <?php
        
         $cname=substr($cname,0,28);
	     echo "<strong>TO:".$cname."<br>";
...
<div style="width:90mm;height:14mm;text-align:left;">
<img src="barcode128.class.php?data=<?php echo $ebay_id;?>"  width="178" height="35"/><?php echo "*".$ebay_id."*";?>  

</div>

<div style="width:68mm;height:26mm;margin-bottom:10px; border-top:1px dashed #000000; font-size:13px">   
<?php 
		...
		for($g=0;$g<count($ss);$g++){
			...
			$goods_name		= $si[0]['goods_name'];
			
		
		
			  
			echo $goods_name."*".$ebay_amount.' ';
      
		}
		if($ebay_noteb)echo '<br>'.$ebay_noteb;   
		
		
		if($ebay_tracknumber != '' ){
?>

<div style="text-align:center"><strong>HONG KONG</strong></div>
<div style="text-align:center"><strong style=" font-size:22px">R</strong><span><?php echo ' '.substr($ebay_tracknumber,0,2);?></span>


<span><?php echo ' '.substr($ebay_tracknumber,2,3);?></span>
<span><?php echo ' '.substr($ebay_tracknumber,5,3);?></span>
<span><?php echo ' '.substr($ebay_tracknumber,8,3);?></span>
<strong> HK</strong>
</div>

<img src="barcode128.class.php?data=<?php echo $ebay_tracknumber;?>"  width="345" height="66"/>
