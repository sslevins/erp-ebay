...
<?PHP
	...
	function eubtracknumber($ordersn){
		...
		global $dbcon,$user,$appID,$devID,$certID;
		...
		$goods_zysbmc = '电子元器件 ';
		$goods_sbjz   = '1';
		$goods_ywsbmc =  substr($goods_ywsbmc,0,30);
		...
		//$soapclient = new soapclient("https://api.apacshipping.ebay.com.hk/aspapi/v4/ApacShippingService?wsdl");
		...
		foreach($functions as $aa){
			...
			if($ack     != 'Failure'){
				...
				$Message	= $functions->AddAPACShippingPackageResult->NotificationList->Notification->Message;
