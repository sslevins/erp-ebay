...
$objPHPExcel->getProperties()->setCreator("Maarten Balliauw")
	...
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('B1', '运单号');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('C1', '物品描述');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('D1', '备注');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('E1', '目的地');	
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('F1', '收件人');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('G1', '收件地址');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('H1', '收件电话');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('I1', '收件邮编');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('J1', '网络渠道');
	...
	for($i=0;$i<count($sql);$i++){
		...
		$objPHPExcel->setActiveSheetIndex(0)->setCellValue($bb, '');
		$objPHPExcel->setActiveSheetIndex(0)->setCellValue($cc, $sku);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValue($dd, $quantity);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValue($ee, $country[$countryname]);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValue($ff, $name);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValue($gg, $addressline);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValue($hh, $tel);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValue($ii, $zip);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValue($jj, '');
	...
	$objPHPExcel->getActiveSheet(0)->getStyle('G1:G500')->getAlignment()->setWrapText(true);
