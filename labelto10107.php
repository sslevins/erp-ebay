...
$objPHPExcel->getProperties()->setCreator("Maarten Balliauw")
	...
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('A1', '运单号');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('B1', '目的地');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('C1', '网络渠道');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('D1', '类型');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('E1', '件数');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('F1', '重量');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('G1', '发件人');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('H1', '发件单位');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('I1', '发件地址');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('J1', '发件电话');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('K1', '发件邮编');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('L1', '发件国家');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('M1', '发件省州');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('N1', '发件城市');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('O1', '收件人');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('P1', '收件单位');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('Q1', '收件地址');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('R1', '收件电话');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('S1', '收件邮编');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('T1', '收件国家');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('U1', '收件省州');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('V1', '收件城市');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('W1', '物品描述');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('X1', '物品数量');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('Y1', '物品单价');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('Z1', '物品包装');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AA1', '托运备注');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AB1', '声明价值');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AC1', '投保价值');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AD1', '计价货币');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AE1', '原产地');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AF1', '代收货款');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AG1', '代收货款返回');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AH1', '付款方式');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AI1', '备注');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AJ1', '短信电话');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AK1', '发件邮箱');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AL1', '收件邮箱');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AM1', '收件短信');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AN1', '标签');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AO1', '所属部门');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AP1', '转单号');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AQ1', '参考号');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AR1', '报关号');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AS1', '留用串');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AT1', '留用数');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AU1', '备用一');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AV1', '备用二');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AW1', '备用三');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AX1', '备用四');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AY1', '备用五');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AZ1', '收件地址1');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('BA1', '收件地址2');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('BB1', '收件地址3');
	...
	for($i=0;$i<count($sql);$i++){
		...
		$strline					= date('Y').date('m').date('d').chr(13).$ebay_userid;
		...
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('A'.$a, $orderid, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('B'.$a, $countryname, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('C'.$a, $ebay_carrier, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('D'.$a, '包裹', PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('E'.$a, '1', PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('O'.$a, $ebay_userid, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('Q'.$a, $street1, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('R'.$a, $tel, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('S'.$a, $zip, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('AP'.$a, $ebay_tracknumber, PHPExcel_Cell_DataType::TYPE_STRING);
		$a++;
...
$title		= "客户预录单";
$titlename		= "客户预录单".date('Y-m-d').".xls";
