...
<tr>
	...
	<tr>
		<td valign="top" colspan="2" style="border: 0px; border-top: 0px; border-top-style: dashed; width: 7cm; padding: 3px; height: 3.5cm" align="left">
				...
				<tbody><tr>
					...
					<td style="width: 7cm;" align="center" colspan="2">
						<table cellpadding="0" cellspacing="0">
							...
							<tr>
								<td align="center">
								 	<img src="barcode128.class.php?data=<?php echo $ebay_id; ?>" alt="" width="119" height="61"/>
	...
	<tr>
		<td valign="top" colspan="2" style="border: 0px; border-top: 0px; border-top-style: dashed; width: 7cm; padding: 3px; height: 3.5cm" align="left">
			<div style="font-size: 15px; float: left; word-spacing: normal; width: 6.5cm;">
				<b style="font-size: 13px;">To:&nbsp;</b> 
				<b style="font-size: 13px;"> Catharina Claessens</b>
			    <br>
				Riverside<br>2682 Peak Hill Railway Road<br>Tomingley, NSW 2869<br>Australia
				...
				<tbody><tr>
					...
					<td style="width: 7cm;" align="center" colspan="2">
						<table cellpadding="0" cellspacing="0">
							...
							<tr>
								<td align="center">
								 	<img src="barcode4px(4)" width="210px" height="39">
