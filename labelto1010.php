...
$objPHPExcel->getProperties()->setCreator("Maarten Balliauw")
	...
	for($i=0;$i<count($sql);$i++){
		...
		$ebay_markettime				= date('Y-m-d',$sql[$i]['ebay_markettime']);
		...
		for($o=0;$o<count($sl);$o++){					
			...
			$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('A'.$a, $paidtime, PHPExcel_Cell_DataType::TYPE_STRING);
			$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('B'.$a, $ebay_account, PHPExcel_Cell_DataType::TYPE_STRING);
			$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('C'.$a, $sku1, PHPExcel_Cell_DataType::TYPE_STRING);
			$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('D'.$a, $amount, PHPExcel_Cell_DataType::TYPE_STRING);
			$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('E'.$a, $ebay_itemprice, PHPExcel_Cell_DataType::TYPE_STRING);
			$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('F'.$a, $countryname, PHPExcel_Cell_DataType::TYPE_STRING);
