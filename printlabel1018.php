...
$Shipping		= $_REQUEST['Shipping'];
 ...
 ?>
	<div style="width:91mm;min-height:62mm;float:left;border:1px double black;padding:1mm;font-size:12px; margin:1px;">
		<div style="width:100%;border-bottom:1px dashed #000000;">
			...
			<?php
				$weight		= 0;
				$ee			= "select ebay_amount,sku,ebay_itemtitle,notes from ebay_orderdetail where ebay_ordersn='$sn'";
				...
				foreach($ee as $key=>$val){
					...
					$t = $key+1;
					if($t%2==0){
						echo '<td width="50%">'.$ebay_amount.'*'.$sku.' '.$notes.';</td></tr><tr>';
					}else{
						echo '<td width="50%">'.$ebay_amount.'*'.$sku.' '.$notes.';</td>';
					}
				}
		...
		<div style="width:100%;height:4mm;padding-top:1mm; font-size:14px;">
			<div style="width:60%;height:4mm;float:left; line-height:4mm">
					From: <strong> &nbsp;<?php
			...
			<div style="width:30%;height:4mm;float:right;">
					<strong><?php echo $carrier;?></strong>
			</div>
		</div>
	  ...
	  <div style='width:100%; margin-top:5px;'>
		<div style='width:100%;'><img src='barcode128.class.php?data=<?php echo $ebay_id;?>' width='315' height='35'/>
		</div>
		<div style='width:88%; font-size:14px; margin-top:1px;'>
			<span style='float:left;'>【】</span>
			<span style='float:left;margin-left:50px'><?php echo $ebay_id;?></span><span style='float:right'>重量:<?php echo $weight;?>KG</span>
		</div>
		</div>
	</div>
