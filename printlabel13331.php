...
<div style="width:152mm;height:241mm;font-size:14px; position:relative;">
	<div style="width:80px;height:20px;line-height:20px; left:80px;top:135px; position:absolute"><?php echo $fname; ?></div> 
	<div style="width:180px;height:20px;line-height:20px; left:180px;top:135px; position:absolute"><?php echo $ftel; ?></div> 
	<div style="width:105px;height:20px;line-height:20px; left:45px;top:170px; position:absolute"><?php echo $fcity; ?></div> 
	<div style="width:80px;height:20px;line-height:20px; left:240px;top:170px; position:absolute"><?php echo $fcountry; ?></div> 
	<div style="width:240px;line-height:20px; left:80px;top:245px; position:absolute"><?php echo $faddress; ?></div>
	<div style="width:105px;height:20px;line-height:20px; left:75px;top:320px; position:absolute"><?php echo $fzip; ?></div>
	<div style="width:80px;height:20px;line-height:20px; left:265px;top:320px; position:absolute"><?php echo $carrier_sn; ?></div>
	
	
	<div style="width:240px;height:20px;line-height:20px; left:430px;top:90px; position:absolute"><?php echo $tname; ?></div>
	<div style="width:120px;height:20px;line-height:20px; left:430px;top:130px; position:absolute"><?php echo $tcity; ?></div>
	<div style="width:120px;height:20px;line-height:20px; left:550px;top:130px; position:absolute"><?php echo $tcountryname; ?></div>
	<div style="width:365px;line-height:20px; left:375px;top:210px; position:absolute"><?php echo $toaddress; ?></div>
	<div style="width:120px;height:20px;line-height:20px; left:385px;top:284px; position:absolute"><?php echo $tzip; ?></div>
	<div style="width:140px;height:20px;line-height:20px; left:560px;top:284px; position:absolute"><?php echo $ttel; ?></div>
	<?php
