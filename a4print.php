...
<table style="width:105mm" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>   
    ...
    <td>
    <table width="400px" height="232px"   border="0" cellpadding="0" cellspacing="0"  >


      <tr>
        <td width="85%" height="35" valign="top">
        
        <?php if($ebay_carrier == '香港挂号'){  ?>
        <table width="100%" cellpadding="5" cellspacing="0" bordercolor="#000000" style="border:1px dashed #000000">
          <tr>
            <td colspan="2"><div style=" font-size:13px">
                <?php
				...
				for($g=0;$g<count($ss);$g++){
					...
					echo '<br><b>'.$ebay_amount.' * '.$sku.'</b>('.$ebay_itemtitle.')';
          ...
          <tr >
            <td colspan="2" style=" border-bottom:1px dashed #000000"><div align="center" class="STYLE1">NO:<?php echo $ordersn; ?>&nbsp;&nbsp;<?php echo date('y').'-'.date('m').'-'.date('d'); 
          ...
          <tr>
            <td width="50%">From:<span style="font-size:14px"><?php echo $ebayaccount;?><br/>
              <?php echo nl2br($address);?></span></td>
            <td width="50%"><table width="86%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000" >
              <tr>
          ...
          <tr>
            <td rowspan="2" style=" "><div align="left" style="font-size:18px">&nbsp;
		 ...
		 ?>
          ...
          <tr >
            <td colspan="2" style=" border-bottom:1px dashed #000000"><div align="center"> <?php echo $ordersn; ?><br />
                    <img src="barcode128.class.php?data=<?php echo $ebay_id;?>" width="143" height="38" /> </div>
...
<table width="100%" cellpadding="5" cellspacing="0" bordercolor="#000000" style="border:1px dashed #000000">
			...
			?>
              ...
              <tr>
            <td width="50%"><strong>From:<?php echo $ebayaccount;?></strong><br/><?php echo nl2br($address);?></td>
            <td width="50%"><table width="86%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000" >
              <tr>
                <td><div align="center" class="STYLE3" >1</div></td>
                <td ><div align="center" class="STYLE3">POSTAGE PAID HONG KONG</div></td>
		...
		echo $street1." ".$street2;
		 ...
		 ?></div></td>
          ...
          <tr >
            <td style=" border-bottom:1px dashed #000000"><div align="center">&nbsp;</div></td>
            <td align="right" style=" border-bottom:1px dashed #000000; margin-right:3px"><div align="right">&nbsp;<?php   	echo $country[$countryname];
          ...
          <tr >
            ...
            <div align="right">NO:<?php echo $ordersn; ?>&nbsp;&nbsp;<?php echo '&nbsp;&nbsp;&nbsp;&nbsp;'.($i+1).'/'.$totalcounts
        ...
        <table width="100%" cellpadding="5" cellspacing="0" bordercolor="#000000" style="border:1px dashed #000000">
			...
			?>
              ...
              <tr>
            <td width="50%"><strong>From:<span style="font-size:14px"><?php echo $ebayaccount;?><br/><?php echo nl2br($address);?></span></strong></td>
            <td width="50%">&nbsp;</td>
              </tr>
		...
		echo $street1." ".$street2;
		 ...
		 ?></div></td>
          ...
          <tr >
            ...
            <div align="right">NO:<?php echo $ordersn; ?>&nbsp;&nbsp;<?php
        ...
        <table width="100%" cellpadding="5" cellspacing="0" bordercolor="#000000" style="border:1px dashed #000000">
			...
			?>
                    ...
                    <td colspan="2"><table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
                      ...
                      <tr>
                        <td valign="top"><p class="STYLE3">If undeliverable,please return to:<br />
                          <strong><span style="font-size:14px"><?php echo nl2br($address);?></span></strong></p></td>
                  ...
                  <tr>
            <td width="50%"><strong>From:<?php echo $ebayaccount;?></strong></td>
            <td width="50%">&nbsp;</td>
              </tr>
		...
		echo $street1." ".$street2;
		 ...
		 ?></div></td>
          ...
          <tr >
            <td style=" border-bottom:1px dashed #000000"><div align="center">&nbsp;</div></td>
            <td align="right" style=" border-bottom:1px dashed #000000; margin-right:3px"><div align="right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div></td>
          </tr>
          <tr >
            <td colspan="2" style=" border-bottom:1px dashed #000000">
               <div align="center">
  ...
  <td height="0px" ></td>
	...
	if(($i+1)%6 == 0 && $i !=0) echo '</tr></table><div style="PAGE-BREAK-AFTER: always">&nbsp;&nbsp;</div><table  style="width:105mm" border="0" cellpadding="0" cellspacing="0"><tr>';
