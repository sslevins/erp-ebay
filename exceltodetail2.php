...
<table width="700" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>   
    ...
    <table width="100%" height="100" border="0" cellpadding="0" cellspacing="0"  style="">
      ...
      <tr>
        <td height="55"><div align="left"><?php
		echo "TO<BR>";
		 echo $cname;
      ...
      <tr>
        <td height="35"><table width="100%" border="0" cellpadding="3" cellspacing="1" bordercolor="#000000" bgcolor="#000000">
          <tr>
            <td width="13%" bgcolor="#FFFFFF">Ref</td>
            <td width="54%" bgcolor="#FFFFFF"><?php echo $ebay_ptid;?>&nbsp;</td>
            <td width="33%" bgcolor="#FFFFFF">&nbsp;</td>
          </tr>
          <tr>
            <td colspan="3" bgcolor="#FFFFFF">配货信息<br />
<?php
      ...
      <tr>
        <td height="35"><?php echo  $ebayaccount; ?>&nbsp;</td>
      </tr>
    </table></td>
  </tr>
  ...
  <td height="0px" style="page-break-after:always;"></td>
  </tr>
