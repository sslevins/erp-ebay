  ...
  <tr>   
    ...
    <td width="480" align="center" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding:5px">
      ...
      <tr>
        ...
        <td width="96%" colspan="3"><div align="left" style="margin:0px 0px 5px 10px; font-size:18px; font-family:Arial, Helvetica, sans-serif"><?php echo "TO:<br>".$addressline;?></div></td>
