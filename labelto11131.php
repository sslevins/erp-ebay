...
$country['turkey']					=	'土耳其';
	...
	$country['Zambia']					=	'赞比亚';
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('A1', 'Item Number');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('B1', '客户邮箱');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('C1', 'SKU*数量');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('D1', '产品标题');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('E1', '图片');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('F1', '买家Paypal地址');
	...
	for($i=0;$i<count($sql);$i++){
		...
		$objPHPExcel->setActiveSheetIndex(0)->getCell('A'.$a)->setValueExplicit($strline3, PHPExcel_Cell_DataType::TYPE_STRING);
