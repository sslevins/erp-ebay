...
<h2><?php echo $_REQUEST['action'].$status;?> &nbsp; <a href="instore.php?module=warehouse&stype=0&dstatus=0&action=入库单">未审核(
    <?php
		
		$sql		= "select id from ebay_iostore where (io_status=0 or io_status='') and type='0' and ebay_user='$user'";		
    ...
    )</a>&nbsp;&nbsp;&nbsp; <a href="instore.php?module=warehouse&stype=0&dstatus=1&action=入库单">已审核(
    
    <?php
		
		$sql		= "select id from ebay_iostore where io_status=1 and type='0' and ebay_user='$user'";	
    ...
    )</a>&nbsp;&nbsp;&nbsp;<?php if(in_array("s_i_add",$cpower)) {?><a href="instoreadd.php?stype=<?php echo $stype;?>&module=warehouse"; target="_parent">添加入库单</a><?php }?></h2>
</div>
...
<table cellpadding='0' cellspacing='0' width='100%' border='0' class='list view'>
   ...
   <?php 
				  	...
				  	$sql = "select id,io_ordersn,io_addtime,io_warehouse,io_status,operationuser,audituser,io_type,io_audittime from  ebay_iostore as a  where a.ebay_user='$user' and a.type='0' and a.io_status='$dstatus'";	
					  
					if($searchs == '1') $sql = "select a.id,a.io_ordersn,io_addtime,io_warehouse,io_status,operationuser,audituser,io_type,io_audittime from  ebay_iostore as a join ebay_iostoredetail as b on a.io_ordersn = b.io_ordersn where a.ebay_user='$user' and a.type='0' and a.io_status='$dstatus' and b.goods_sn='$keys' ";	
					...
					if($searchs == '1') $sql .=" group by a.io_ordersn ";
...
$page=new page(array('total'=>$total,'perpage'=>$pagesize));
				...
				$totalss = 0;					
				  ...
				  ?>
					<tr height='20' class='oddListRowS1'>
						    ...
						    <td scope='row' align='left' valign="top" ><?php echo $strtype;?>&nbsp;-<?php echo $io_typename;?></td>
						    ...
						    <td scope='row' align='left' valign="top" ><?php if(in_array("s_i_modify",$cpower)) {?><a href="instoreadd.php?storeid=<?php echo $id; ?>&module=warehouse&action=入库&io_ordersn=<?php echo $io_ordersn;?>&stype=<?php echo $stype; ?>" target="_parent">修改</a> <?php }?>
                            <?php if($dstatus =='0'){ ?>
                          <?php if(in_array("s_i_delete",$cpower)) {?>  <a href="#" onClick="del(<?php echo $id; ?>)">删除</a><?php }?>
						    <?php } ?>&nbsp;</td>
			 		</tr>
		...
		<td colspan='11'>
			<table border='0' cellpadding='0' cellspacing='0' width='100%' class='paginationTable'>
				<tr>
					<td colspan="12" align="center" nowrap="nowrap" class='paginationActionButtons'><?    echo '<br><center>'.$page->show(2)."</center>";//输出分页 ?></td>
			  </tr>
				<tr>
				  <td nowrap="nowrap" class='paginationActionButtons' align="center">&nbsp;</td>
			      <td nowrap="nowrap" class='paginationActionButtons' align="center">&nbsp;</td>
			      <td nowrap="nowrap" class='paginationActionButtons' align="center">&nbsp;</td>
			      <td nowrap="nowrap" class='paginationActionButtons' align="center">&nbsp;</td>
			      <td nowrap="nowrap" class='paginationActionButtons' align="center">&nbsp;</td>
			      <td nowrap="nowrap" class='paginationActionButtons' align="center">&nbsp;</td>
			      <td nowrap="nowrap" class='paginationActionButtons' align="right">&nbsp;</td>
			      <td nowrap="nowrap" class='paginationActionButtons' align="center">&nbsp;</td>
			      <td nowrap="nowrap" class='paginationActionButtons' align="center">总计</td>
			      <td nowrap="nowrap" class='paginationActionButtons' align="center"><?php echo number_format($totalss,2); ?></td>
			      <td nowrap="nowrap" class='paginationActionButtons' align="center">&nbsp;</td>
			      <td nowrap="nowrap" class='paginationActionButtons' align="center">&nbsp;</td>
			  </tr>
		  </table>		</td>
...
<script language="javascript">
	...
	function del(id){
		if(confirm('您确认删除此条记录吗')){
			location.href = 'instore.php?module=warehouse&action=入库单&stype=<?php echo $stype; ?>&id='+id+'&type=del&dstatus=<?php echo $dstatus; ?>';
		}
	}
	...
	function searchorder(){
		...
		location.href	= 'instore.php?keys='+keys+"&module=warehouse&action=入库单&stype=<?php echo $stype; ?>&dstatus=<?php echo $dstatus; ?>&warehouse="+warehouse+"&startdate="+startdate+"&enddate="+enddate+"&searchs="+searchs+"&timess="+times+"&factory="+factory;
	}
