...
<html>
 <body>
 <div style="width:85mm;height:60mm;background-corlor:White;font-size:12px;"> 
<?php
...
//idPrint3.disabled = false; 
   ...
   <?php
 	for($i=0;$i<count($sql);$i++){
				...
				if($user =='vipmt') $ebay_id ='TB'.$ebay_id;
...
<div style="width:80mm;height:55mm;border:2px solid black;font-size:12px;float:left;margin:1px;">

<div style="width:80mm;height:29mm;background-corlor:White;margin-top:5px;line-height:5mm">     
...
<div style="width:80mm;height:9mm;text-align:left;">
<img src="barcode128.class.php?data=<?php echo $ebay_id;?>"  width="180px" height="30px" ;"/>
 <?php echo "(".$ebay_id.")".$ebay_carrier;?>

</div>
<div style="width:80mm;height:3mm;margin-left:30px; ">  
<?php echo date('Y-m-d').' '.($i+1).' / '.$totalpages.' AT:'.$ebay_total.' WT:'.$orderweight;?>  

</div>
<div style="width:80mm;margin-bottom:5px;">   
<?php echo "...................................";?>  
<?php echo "<br>";?>  
 <?php
		...
		for($g=0;$g<count($ss);$g++){
			...
			$ebay_amount		= $ss[$g]['ebay_amount'];
			 $sku				= $ss[$g]['sku'];
			  ...
			  ?>
<?php echo $sku."*".$ebay_amount;?>

<?php if($g==(count($ss)-1))echo "<br>";?>
<?php if($g==(count($ss)-1)) echo $ebay_noteb;?>          
<?php }
