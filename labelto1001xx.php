...
$objPHPExcel->getProperties()->setCreator("Maarten Balliauw")
	...
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('B1', '商品交易号');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('C1', '商品SKU');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('D1', '数量');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('E1', '收件人姓名（英文）');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('F1', '收件人地址1（英文）');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('G1', '收件人地址2（英文）');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('H1', '收件人地址3（英文）');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('I1', '收件人城市');
	
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('J1', '收件人州');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('K1', '收件人邮编');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('L1', '收件人国家');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('M1', '收件人电话');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('N1', '收件人电子邮箱');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('O1', '自定义信息1');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('P1', '备注');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('Q1', '来源');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('R1', '寄件地址');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('S1', '发货地址');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('T1', '业务类型');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('U1', '增值服务');
	...
	for($i=0;$i<count($sql);$i++){
		...
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('A'.$a, $ordersn, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('C'.$a, $sl[0]['sku'], PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('D'.$a, $sl[0]['ebay_amount'], PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('E'.$a, $name, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('F'.$a, $street1, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('G'.$a, $street2, PHPExcel_Cell_DataType::TYPE_STRING);
		...
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('M'.$a, $tel, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('O'.$a, $labelstr, PHPExcel_Cell_DataType::TYPE_STRING);
