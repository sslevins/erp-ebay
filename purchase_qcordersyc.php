...
<table cellpadding='0' cellspacing='0' width='100%' border='0' class='list view'>
   ...
   <?php 
				  	...
				  	$sql = "select * from  ebay_iostore as a  where a.ebay_user='$user' and a.type='95' and a.io_status='0'";	
					
					if($keys != '') $sql = "select * from  ebay_iostore as a join ebay_iostoredetail as b on a.io_ordersn = b.io_ordersn where a.ebay_user='$user' and a.type='95' and a.io_status='0' and b.goods_sn='$keys' ";	
				...
				$sql = $sql.$limit;
				  ...
				  ?>
					<tr height='20' class='oddListRowS1'>
						    ...
						    <td scope='row' align='left' valign="top" ><a href="purchaseorderaddv3.php?storeid=<?php echo $id; ?>&module=purchase&action=&io_ordersn=<?php echo $io_ordersn;?>&stype=qcorderssyc" target="_parent">审核</a>&nbsp;</td>
			 		</tr>
...
<script language="javascript">
	...
	function searchorder(){
		...
		location.href	= 'purchase_qcordersyc.php?keys='+keys+"&module=purchase&action=&stype=<?php echo $stype; ?>&dstatus=<?php echo $dstatus; ?>&warehouse="+warehouse+"&startdate="+startdate+"&enddate="+enddate;
	}
