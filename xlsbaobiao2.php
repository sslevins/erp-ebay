...
$objPHPExcel->getProperties()->setCreator("Maarten Balliauw")
	...
	for($i=0;$i<count($sql);$i++){
		...
		$ebay_carrier		= 'Hongkong Post Air Mail';
		}
		...
		$ebay_carrier		= 'China Post Air Mail';
		}
		...
		for($g=0;$g<count($ss);$g++){
			...
			$recordnumber0			= @$ss[$g]['recordnumber'];
			$objPHPExcel->setActiveSheetIndex(0)->getCell('A'.$a)->setValueExplicit($recordnumber0, PHPExcel_Cell_DataType::TYPE_STRING);
			$objPHPExcel->setActiveSheetIndex(0)->setCellValue('B'.$a, '');
