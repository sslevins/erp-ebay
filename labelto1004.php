...
$objPHPExcel->getProperties()->setCreator("Maarten Balliauw")
	...
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('Q1', 'Postage and Handling');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('R1', 'Insurance');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('S1', 'Cash on delivery fee');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('T1', 'Total Price');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('U1', 'Payment Method');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('V1', 'Sale Date');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('W1', 'Checkout Date');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('X1', 'Paid on Date');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('Y1', 'Posted on Date');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('Z1', 'Feedback left');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AA1', 'Feedback received');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AB1', 'Notes to yourself');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AC1', 'PayPal Transaction ID');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AD1', 'Postage Service');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AE1', 'Cash on delivery option');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AF1', 'Transaction ID');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AG1', 'Order ID');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AH1', 'Variation Details');
...
$ebay_shiptype			= $sl[$o]['ebay_shiptype'];
			...
			$objPHPExcel->setActiveSheetIndex(0)->getCell('N'.$a)->setValueExplicit($labelstr, PHPExcel_Cell_DataType::TYPE_STRING);
			...
			$objPHPExcel->setActiveSheetIndex(0)->getCell('Q'.$a)->setValueExplicit($ebay_shipfee, PHPExcel_Cell_DataType::TYPE_STRING);
			$objPHPExcel->setActiveSheetIndex(0)->getCell('R'.$a)->setValueExplicit($InsuranceFee, PHPExcel_Cell_DataType::TYPE_STRING);
			$objPHPExcel->setActiveSheetIndex(0)->getCell('T'.$a)->setValueExplicit($ebay_total, PHPExcel_Cell_DataType::TYPE_STRING);
			$objPHPExcel->setActiveSheetIndex(0)->getCell('U'.$a)->setValueExplicit($PaymentMethodUsed, PHPExcel_Cell_DataType::TYPE_STRING);
			$objPHPExcel->setActiveSheetIndex(0)->getCell('V'.$a)->setValueExplicit($ebay_createdtime, PHPExcel_Cell_DataType::TYPE_STRING);
			$objPHPExcel->setActiveSheetIndex(0)->getCell('W'.$a)->setValueExplicit($ebay_paidtime, PHPExcel_Cell_DataType::TYPE_STRING);
			$objPHPExcel->setActiveSheetIndex(0)->getCell('X'.$a)->setValueExplicit($ebay_paidtime, PHPExcel_Cell_DataType::TYPE_STRING);
			$objPHPExcel->setActiveSheetIndex(0)->getCell('Z'.$a)->setValueExplicit('NO', PHPExcel_Cell_DataType::TYPE_STRING);
			$objPHPExcel->setActiveSheetIndex(0)->getCell('AC'.$a)->setValueExplicit($ebay_ptid, PHPExcel_Cell_DataType::TYPE_STRING);
			$objPHPExcel->setActiveSheetIndex(0)->getCell('AE'.$a)->setValueExplicit($ebay_shiptype, PHPExcel_Cell_DataType::TYPE_STRING);
			$objPHPExcel->setActiveSheetIndex(0)->getCell('AF'.$a)->setValueExplicit($ebay_tid, PHPExcel_Cell_DataType::TYPE_STRING);
