...
<?php
	...
	$country['France métropolitaine']				=	'法国';
	$country['Belgique']				=	'比利时';
	$country['Deutschland']				=	'德国';
	$country['Griechenland']				=	'希腊';
...
//idPrint3.disabled = false; 
   ...
   $pages	= 1;
 	...
 	for($i=0;$i<count($sql);$i++){
				...
				if($street2 != ''){
					...
					$addressline	= $cname."<br>".$street1.",".$street2."<br>".$city.",".$state.",".$zip;
					
					
				
				}else{
					
					$addressline	= $cname."<br>".$street1."<br>".$city.", ".$state.",".$zip;
				...
				$addressline		.= "<br>".$countryname;
				
				
				}else{
				$addressline		.= "<br>".$countryname."(".$country[$countryname].")";
				...
				if($ebay_phone1 != '') $addressline .= "<br>Mobile:".$ebay_phone1;
				
				
				
				
			$ss					= "select * from ebay_account where ebay_account='$ebayaccount'";			
			$ss					= $dbcon->execute($ss);
  ...
  ?>
<table width="80%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" style="width:200mm; text-align: right;">
  <tr>   
    <td width="480" align="center" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding:5px">
      ...
      <tr>
        ...
        <td width="96%" colspan="3"><div align="left" style="margin:0px 0px 5px 10px; font-size:12px; font-family:Arial, Helvetica, sans-serif"><?php 
		
		if($user == 'viphong') echo 'From:<br> H&Y Wall Art Pty Ltd <br> PO Box 6074 <br> Alexandria,NSW 2015 Australia<br /><br />
';

		?></div>
        <div style="margin:0px 3px 0px 160px; font-size:18px; font-family:Arial, Helvetica, sans-serif">
		
		<?php echo "TO:".$addressline;?></div></td>
        <td width="6%" height="100" valign="top"><span class="STYLE16"></span>
          <table width="80%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td><img src="barcode128.class.php?data=<?php echo $ebayid; ?>" alt="" width="119" height="61"/></td>
            </tr>
            <tr>
            ...
            <tr>
              <td><?php  echo 'No: '.$recordnumber;?>&nbsp;</td>
            </tr>
          </table></td>
      </tr>
    ...
    <td width="308" align="center" valign="top"><table width="100%" border="0" cellspacing="1" cellpadding="3">
        ...
        <tr>
          <td><div align="left" style="margin:10px; font-size:12px; font-family:Arial, Helvetica, sans-serif;width:auto;float:left">
            <?php
		  	$sl	= "select notes,ebay_itemurl,sku,ebay_amount from ebay_orderdetail where ebay_ordersn='$ordersn'";
		$sl	= $dbcon->execute($sl);
		...
		for($o=0;$o<count($sl);$o++){			
			...
			if($notes != '' ) $notes = ' 产品备注<strong>:'.$notes.'</strong>';
			...
			echo "<font style='font-weight: bold;'>".$goods_sn."  {$goods_location} ".$goods_name." X ".$goddscount."/</font><br>";	
			...
			echo "<font style='font-weight: bold;'>".$sku."  {$goods_location} ".$goods_name." X ".$amount.' '.$notes."/</font><br>";	
        ...
        <tr>
          <td>
            <span class="STYLE17"><?php echo '客户ID &nbsp: '.$userid.' '.$ebay_carrier.'<br>';
		   echo 'RecordNo: '.$recordnumber.'<br>';
		   echo '包装规格: '.$packingtype;
		   if($ebay_noteb != '' ) echo '<br>客服备注:<strong>'.$ebay_noteb.'</strong>';
		   
		   
		   echo "Total: ".$ebay_total;
