	...
	<div style="width:91mm;min-height:62mm;float:left;border:1px dashed black;padding:1mm;font-size:12px; margin:1px;">
		<div style="width:100%;border-bottom:1px dashed #000000;">
			...
			<?php
				...
				foreach($ee as $key=>$val){
					...
					$t = $key+1;
					if($t%2==0){
						echo '<td width="50%">'.$ebay_amount.'*'.$sku.';</td></tr><tr>';
					}else{
						echo '<td width="50%">'.$ebay_amount.'*'.$sku.';</td>';
					}
				}
		...
		<div style="width:100%;height:4mm;padding-top:1mm; font-size:14px;">
			<div style="width:95%;float:left;">
					<div style='height:4mm;line-height:4mm;width:100%'>From: <strong> JC Sportline</strong></div><div style='font-size:10px;line-height:4mm;margin-left:40px;'>2#-602 BaoZuan Industrail Area, Bu Lan Road 182, Bu Ji Town, Long Gang, ShenZhen, China</div>
			</div>
		</div>
	  ...
	  <div style='width:100%; margin-top:5px;'>
		...
		<div style='width:88%; font-size:14px; margin-top:1px;'>
			<span style='float:left;margin-left:140px'><?php echo $ebay_id;?></span>
		</div>
		</div>
	</div>
