 ...
 ***********************************************************************/
 ...
 invokeListOrders($service, $request);
	    ...
	    $start		= date('Y-m-d H:i:s',strtotime('-0 hour',strtotime($start.' 00:00:00')));
                       ...
                       //         echo("                            " . $order->getSellerOrderId() . "\n");
                            ...
                            if ($order->isSetShippingAddress()) { 
                                ...
                                if ($shippingAddress->isSetStateOrRegion()) 
                                {
									...
									$StateOrProvince						=  mysql_escape_string($shippingAddress->getStateOrRegion());
                                }
                     ...
                     //           echo("                            " . $orderItem->getQuantityShipped() . "\n");
                      ...
                      //              echo("                                " . $itemPrice->getCurrencyCode() . "\n");
                          ...
                          //      echo("                        GiftWrapPrice\n");
							...
							if($user == 'vipzwm') $ebayitemprice			= $ebayitemprice / $amount;
