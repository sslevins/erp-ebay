...
<script language="javascript">
	...
	function xlsbaobiao(){
		...
		var url			= 'printxlsbaobiao.php?start='+start+"&end="+end+"&account="+encodeURIComponent(account)+"&ebay_carrier="+encodeURIComponent(ebay_carrier);
	...
	function xlsbaobiao1(){
		...
		var url			= 'printxlsbaobiao04.php?start='+start+"&end="+end+"&account="+encodeURIComponent(account)+"&ebay_carrier="+encodeURIComponent(ebay_carrier);
		window.open(url,"_blank");
