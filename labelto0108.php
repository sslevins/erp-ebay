...
$country['turkey']					=	'土耳其';
	...
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('B1', '全称');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('C1', '联系人');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('D1', '电话');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('E1', '省');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('F1', '市');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('G1', '镇区');
	...
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('L1', '目的站');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('M1', '内件说明');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('N1', '费用');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('O1', '重量');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('P1', '件数');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('Q1', '备注');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('R1', '批打分组');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('S1', '体积');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('T1', '代收金额');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('U1', '手续费');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('V1', '保价金额');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('W1', '保价费');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('X1', '运费');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('Y1', '加急费');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('Z1', '包装费');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AA1', '送货费');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AB1', '其它费');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AC1', '金额大写1');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AD1', '自定义3');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AE1', '自定义4');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AF1', '自定义5');
	...
	$sql	= "select * from ebay_order as a where ebay_user='$user' and a.ebay_status='$status' and a.ebay_combine!='1' ";	
	...
	for($i=0;$i<count($sql);$i++){
		...
		$addressline	= $street1;
		if($street2) $addressline.= chr(10).$street2;
		$addressline   .= chr(10).$city.", ".$state.', '.$zip.chr(10).$countryname." ".$country[$countryname];
		...
		$objPHPExcel->setActiveSheetIndex(0)->getCell('D'.$a)->setValueExplicit($tel, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->getCell('H'.$a)->setValueExplicit($addressline, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->getCell('I'.$a)->setValueExplicit($zip, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->getCell('K'.$a)->setValueExplicit($countryname.' '.$country[$countryname], PHPExcel_Cell_DataType::TYPE_STRING);
		$a++;
}
...
$title			= "XIAOLANG".date('Y-m-d');
$titlename		= "XIAOLANG".date('Y-m-d').".xls";
