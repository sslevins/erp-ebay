...
<?php
	...
	if($_POST['submit']){
		...
		$reason		= $_POST['reason'];
		if($module  == 'refund'){
			$sql	= "update ebay_order set resendreason='$reason',ebay_status='993' where ebay_ordersn='$ordersn'";
			...
			$sql	= "update ebay_order set resendreason='$reason',ebay_status='996' where ebay_ordersn='$ordersn'";
		}
