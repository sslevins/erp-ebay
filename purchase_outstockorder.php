...
按照SKU 信息汇总后可直接加入采购计划列表中</td>
   ...
   <?php 
				...
				//	echo '开始检查订单编号:'.$ebay_id.'<br>';
							...
							$vvsql		    = "select sku,ebay_amount,ebay_id,notes from ebay_orderdetail where ebay_ordersn='$ebay_ordersn' ";
...
<?php 
	...
	<tr class='pagination'>
        ...
        <?php
						...
						$warehousename			= $vv[0]['store_name'];
						$dataarray				= GetStockQtyBySku($ebay_warehouse,$sku);
						$goods_count			= $dataarray[0]?$dataarray[0]:0;
				...
				//		echo $plancount+$Schedulecount+$ForAcceptancecount.'<br>';
						
				
						
						
						
						$kykc					= $goods_count - $stockused;
						if($kykc <0) $kykc = 0;
					...
					<tr height='20' class='oddListRowS1'>
					  <td scope='row' align='left' valign="top" ><?php if($isadd>0){?><input name="ordersn" type="checkbox" id="ordersn" value="<?php echo $sku;?>"    /> <?php } ?></td>
					  <td scope='row' align='left' valign="top" ><?php echo $i+1;?>&nbsp;</td>
                      ...
                      <td scope='row' align='left' valign="top" ><?php echo $warehousename;?>&nbsp;</td>								
						    ...
						    <td scope='row' align='left' valign="top" ><?php echo $goods_note;?>&nbsp;</td>
						    <td scope='row' align='left' valign="top" ><?php echo $goods_count;?>&nbsp;</td>
						    <td scope='row' align='left' valign="top" ><?php echo $kykc;?>&nbsp;</td>
