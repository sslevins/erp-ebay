...
$objPHPExcel->getProperties()->setCreator("Maarten Balliauw")
	...
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('D1', '国家(中文)');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('E1', '国家(英文)');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('F1', '品名(英文)');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('G1', '价值');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('H1', '币种');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('I1', '跟踪号');
	...
	for($i=0;$i<count($sql);$i++){
		...
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('D'.$a, $cnname, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('E'.$a, $countryname, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('F'.$a, $skustr, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('G'.$a, $strstr2, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('H'.$a, $ebay_currency, PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('I'.$a, $ebay_tracknumber, PHPExcel_Cell_DataType::TYPE_STRING);
