...
<input type="button" value="添加入库单" onclick="location.href='purchaseorderaddv3.php?module=purchase&stype=stocktofinace'" /></td>
</tr>
</table>
</div>
...
<table cellpadding='0' cellspacing='0' width='100%' border='0' class='list view'>
	<tr class='pagination'>
		<td colspan='11'>&nbsp;			</td>
				...
				<div style='white-space: nowrap;'width='100%' align='left'>序号</div>			</th>
					...
					<th scope='col' nowrap="nowrap">
				<div style='white-space: nowrap;'width='100%' align='left'>采购单号</div>			</th>
				<th scope='col' nowrap="nowrap">
				<div style='white-space: nowrap;'width='100%' align='left'>供应商单号</div>			</th>
   ...
   <?php 
				  	...
				  	$sql = "select * from  ebay_iostore as a  where a.ebay_user='$user' and a.type='98' and a.io_status='0'";	
					 
					 if($keys != '') $sql = "select * from  ebay_iostore as a join ebay_iostoredetail as b on a.io_ordersn = b.io_ordersn where a.ebay_user='$user' and a.type='98' and a.io_status='0' and b.goods_sn='$keys' ";	
				...
				$sql = $sql.$limit;
				  ...
				  ?>
					<tr height='20' class='oddListRowS1'>
							...
							<a href="purchaseorderaddv3.php?storeid=<?php echo $id; ?>&module=purchase&action=&io_ordersn=<?php echo $io_ordersn;?>&stype=stocktofinace" target="_parent">
							<?php echo $io_ordersn;?></a></td>
							<td scope='row' align='left' valign="top" >
							
							<a href="purchaseorderaddv3.php?storeid=<?php echo $id; ?>&module=purchase&action=&io_ordersn=<?php echo $io_ordersn;?>&stype=stocktofinace" target="_parent">
							<?php echo $sourceorder;?></a></td>							
						    ...
						    <td scope='row' align='left' valign="top" ><font color="#FF0000"><?php echo $reason;?></font></td>
						    <td scope='row' align='left' valign="top" ><a href="purchaseorderaddv3.php?storeid=<?php echo $id; ?>&module=purchase&action=&io_ordersn=<?php echo $io_ordersn;?>&stype=stocktofinace" target="_parent">编辑计划单</a>
...
<script language="javascript">
	...
	function del(id){
		if(confirm('您确认删除此条记录吗')){
			location.href = 'purchase_instock.php?module=purchase&&stype=<?php echo $stype; ?>&id='+id+'&type=del&dstatus=<?php echo $dstatus; ?>';
		}
	}
	...
	function searchorder(){
		...
		location.href	= 'purchase_instock.php?keys='+keys+"&module=purchase&action=&stype=<?php echo $stype; ?>&warehouse="+warehouse+"&startdate="+startdate+"&enddate="+enddate;
