		...
		<td width="65%">
			<table border='0' cellpadding='0' cellspacing='0' width='100%' class='paginationTable'>
             ...
             <?php
						...
						$cc 		= date('Y-m-d');
                    	$start		= date('Y-m-d',strtotime("$cc -20 days"))." 00:00:00";
					 	$start		= strtotime($start);
						
				
						
						$ss			= "";
						$sql	= "select * from ebay_messagetemplate  where id='36'";
						...
						$ss			= "select * from ebay_order  as a  where (a.ShippedTime<=$start) and ebay_feedback=0";
