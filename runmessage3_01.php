<?php
	...
	$vv				= "select distinct user  from ebay_user where  user = 'vipchi'  or user = 'vipnick'  or user = 'silent' or user = 'viphong' or user = 'vip929'  or user = 'survy'    or user = 'viperp'   or user = 'vipyx' or user = 'vipfjadm' or user = 'sz108'";
	$vv				= $dbcon->execute($vv);
